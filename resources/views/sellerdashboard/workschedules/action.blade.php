<a href="{{route('myworkschedule.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deleteworkschedule({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">

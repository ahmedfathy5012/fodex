    ...
    <ul class="menu-nav">
        ...
        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
            <a href="javascript:;" class="menu-link menu-toggle">
                ...
                <span class="menu-text">المنافذ</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="menu-submenu">
                <i class="menu-arrow"></i>
                <ul class="menu-subnav">
                    ...
                    {{--                    <li class="menu-item" aria-haspopup="true">--}}{{--                        <a href="{{ route('seller.central_index') }}" class="menu-link">--}}{{--                            <i class="menu-bullet menu-bullet-dot">--}}{{--                                <span></span>--}}{{--                            </i>--}}{{--                            <span class="menu-text">المطاعم المركزيه </span>--}}{{--                        </a>--}}{{--                    </li>--}}
                ...
                <ul class="menu-subnav">
                    ...
                    <li class="menu-item" aria-haspopup="true">
                        <a href="{{ route('major.index') }}" class="menu-link">
                            ...
                            <span class="menu-text"> الأقسام العامة  </span>
                        </a>
                    </li>
                    <li class="menu-item" aria-haspopup="true">

...
<head>
    ...
    <style>
        ...
        @keyframes realBikeRun {
            0% {
                transform: translateX(var(--bike-travel)) translateY(0) rotate(0deg);
            }

            25% {
                transform: translateX(calc(var(--bike-travel) * 0.75)) translateY(-3px) rotate(-0.5deg);
            }

            50% {
                transform: translateX(calc(var(--bike-travel) * 0.5)) translateY(0) rotate(0deg);
            }

            75% {
                transform: translateX(calc(var(--bike-travel) * 0.25)) translateY(-3px) rotate(-0.5deg);
            }
 ...
 <title>fodex</title> -->
    ...
    <!-- 	<scriptc src="https://cdn.tiny.cloud/1/drwqh7e3jxearaep4ekf9iltoq9m407nkdpz0qr2a9m4ighn/tinymce/5/tinymce.min.js"
...
<div id="preloader1">
    <lottie-player src="{{ asset('72168-loading-food.json') }}" background="transparent"
            ...
            <div class="brand flex-column-auto" id="kt_brand" kt-hidden-height="65"
                ...
                <a href="{{ route('dashboard') }}" class="brand-logo">
                    ...
                    <img alt="Logo"
                         ...
                         src="{{ asset('assets/loaders/modern_delivery_logo_design_clean_transparent.png') }}"
                        ...
                        <div class="topbar">
                            ...
                            <div class="topbar-item">
                                <div
                                    ...
                                    <lottie-player src="{{ asset('6542-handup.json') }}" background="transparent"
                                                   speed="1" style="width: 70px; height:70px;" loop
...
<!--<script
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAFE8D11s7CnPik7kvJsMXW4fVdgpmSDHc&amp;callback=initMap&amp;libraries=&amp;v=weekly"
    defer=""></script>-->

...
<form method="post" action="{{route('boxs.store')}}">
  ...
  <div class="card-body">
      <div class="row">    <div class="mx-auto"><div class="image-input image-input-outline image-input-circle mx-auto"
           id="kt_image_3">
        <div class="image-input-wrapper mb-5" id="im" ></div>
       
        <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow p-4" data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
   ...
   <div class ="row">
      <div class="form-group col-6">
       ...
       @enderror
        ...
        <input type="number" class="form-control" id="height" name="height" value="{{old('height')}}" min="0"  required />
       ...
       @enderror
        ...
        <input type="number" class="form-control" id="width" name="width" value="{{old('width')}}" min="0"  required />

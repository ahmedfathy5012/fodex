...
$sel = Sellercategory::where([['category_id', '=', $id], ['seller_id', '=', $seller_id]])->first();
//$id1 = $sel->category_id;
?>
...
@if($sel)
    ...
    <span class="btn btn-success btn-sm" style="font-size:11px;color:white;" data-toggle="modal" data-target="#myModals{{$id}}">     الترتيب</span>

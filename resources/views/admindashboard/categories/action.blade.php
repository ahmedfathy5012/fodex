<a href="{{route('category.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletecategory({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">

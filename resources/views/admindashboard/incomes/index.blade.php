    ...
    <div class="card card-custom gutter-b">
        <div class="card-header">
            <div class="card-title">
                ...
                <h3 class="card-label"> الايردات</h3>
        ...
        <div class="row">
            <div class="form-group col-lg-3 col-md-6">
                ...
                <select name="country_id" class="form-control selectpicker" onchange="getstates(this)" id="country"
        ...
        <div class="row">
            <a class="btn btn-sm  mt-4 btning" href="{{route('incomes.create')}}">اضافه</a>
        </div>
        <div class="card-body">
            <!--begin: Datatable-->

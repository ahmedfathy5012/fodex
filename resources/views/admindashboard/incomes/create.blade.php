...
<div class="card card-custom">
    ...
    <div class="card-header">
		<div class="card-title">
			...
			<h3 class="card-label">   اضافه ايراد </h3>
		</div>
	</div>
  ...
  <div class="card-body">
   <div class ="row">
      <div class="form-group col-6">
        <label>نوع الايراد <span class="text-danger">*</span></label>
        <select name="collectiontype_id" class="form-control selectpicker" onchange="filtercollectiontype(this)" required>
        ...
        <input type="number" class="form-control" id="value" disabled value="{{old('value')}}" min="0"  required />
         <input type="hidden" class="form-control" id="value1"  value="{{old('value')}}" min="0" name="value" required />
       @error('paid')

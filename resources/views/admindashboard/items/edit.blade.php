...
<form method="post" action="{{route('item.update',$item->id)}}" enctype="multipart/form-data">
 ...
 @enderror
     ...
     <!--   <select name="seller_id" class="form-control selectpicker" required="required" onchange="getsellerscategory(this)" id="seller_id" required="required" data-live-search="true">-->
     <!--     @foreach($sellers as $seller)-->
     <!--     <option value="{{$seller->id}}" @if($item->seller_id == $seller->id) selected @endif>{{$seller->name}}</option>-->
     <!--     @endforeach-->
     <!--   </select>-->
     <!--  @error('seller_id')-->
     <!--  <p style="color:red;">{{$message}}</p>-->

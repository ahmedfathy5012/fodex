        ...
        <form method="post" action="{{route('item.store')}}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="mx-auto col-4">
                        ...
                        <label id="label" for="gallery-photo-add">
                            ...
                            تحميل صور</label>
                        <input type="file" multiple id="gallery-photo-add" class="image custom-file-input"
                               name="image[]">
                    </div>
                    @error('image')
            ...
            <div class='row'>
                ...
                <div class="form-group col-6">
                    ...
                    <select name="seller_id" class="form-control selectpicker" onchange="getsellerscategory(this)"

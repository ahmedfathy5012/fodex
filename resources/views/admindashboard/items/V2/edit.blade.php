            ...
            <form method="post" action="{{route('item.update',$item->id)}}" enctype="multipart/form-data">
                ...
                <div class="card-body product-form-body">
                                ...
                                @foreach($item->images as $image)
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 d-flex align-items-center">
                                        <figure class="imghvr-fade">
                                            <img style="width:100px;height:100px;" src="{{asset('uploads/'.$image->image)}}">
                                        </figure>
                                    </div>
                                @endforeach
                            @endif
                    ...
                    <div class="product-section">
                        ...
                        <section id="section1" class="product-dynamic-section">
                            @if($item->sizes)
                                @foreach($item->sizes as $size)
                                    <div class="row" style="position: relative;" id="remov{{$size->id}}">
                                        ...
                                        <div class="form-group col-1 mt-4">
                                            <button class="btn btn-sm font-weight-bolder btn-light-danger" type="button" onclick="removef({{$size->id}})">
                                                مسح
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="product-section">
                        ...
                        <section id="section2" class="product-dynamic-section">
                            @if($item->extras)
                                @foreach($item->extras as $key3 => $extra)
                                    <div id="removes{{$key3}}">
                                        <div class="row all" style="position: relative;">
                                            ...
                                            <div class="form-group col-1 mt-4">
                                                <button class="btn btn-sm font-weight-bolder btn-light-danger" type="button" onclick="removes({{$extra->id}})">
                                                    مسح
                                                </button>
                                            </div>

                                            <div class="form-group col-1 mt-4">
                                                <button class="btn btn-sm font-weight-bolder btn-light-success" type="button" onclick="get1({{$key3}})">
                                                    اضافه
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        @if($extra->extraDetails)
                                            @foreach($extra->extraDetails as $key => $de)
                                                <div class="row news" style="position: relative;" id="removec{{$de->id}}">
                                                    ...
                                                    <div class="form-group col-1 mt-4">
                                                        <button class="btn btn-sm font-weight-bolder btn-light-danger" type="button" onclick="removec({{$de->id}})">
                                                            مسح
                                                        </button>
                                                    </div>
                                                </div>

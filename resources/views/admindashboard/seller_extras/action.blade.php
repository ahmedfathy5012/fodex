<a href="{{route('seller_extras.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletecoins({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">

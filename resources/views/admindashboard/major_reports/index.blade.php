  ...
  .row .card-block{
    ...
    <div class="card card-custom gutter-b">
		...
		<div class="card-title">
    			<span class="card-icon">
        			...
        			<span class="svg-icon svg-icon-primary svg-icon-2x"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <path d="M5.5,15 L18.5,15 C19.3284271,15 20,15.6715729 20,16.5 C20,17.3284271 19.3284271,18 18.5,18 L5.5,18 C4.67157288,18 4,17.3284271 4,16.5 C4,15.6715729 4.67157288,15 5.5,15 Z M5.5,10 L18.5,10 C19.3284271,10 20,10.6715729 20,11.5 C20,12.3284271 19.3284271,13 18.5,13 L5.5,13 C4.67157288,13 4,12.3284271 4,11.5 C4,10.6715729 4.67157288,10 5.5,10 Z" fill="#000000" opamajor="0.3"/>
                        </g>
    			...
    			<h3 class="card-label">   التقارير الخاصه بالاقسام </h3>
        ...
        <label>الاقسام<span class="text-danger">*</span></label>
        <select name="" class="form-control selectpicker"  id="major" required="required" data-live-search="true">

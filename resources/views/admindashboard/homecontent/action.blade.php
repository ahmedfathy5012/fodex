<a href="{{route('homecontent.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletehomecontent({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">

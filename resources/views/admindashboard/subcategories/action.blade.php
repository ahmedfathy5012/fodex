<a href="{{route('subcategory.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletesubcategory({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">

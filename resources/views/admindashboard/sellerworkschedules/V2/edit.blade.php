        ...
        <div class="card card-custom work-schedule-edit-card">
            ...
            <div class="card-header">
                ...
                <span class="card-icon">
                    ...
                    <h3 class="card-label">تعديل جدول العمل</h3>
                </div>
            </div>

            <form method="post" action="{{ route('sellerworkschedule.update', $work->id) }}" enctype="multipart/form-data">
                @csrf
                @method('put')

                <div class="card-body work-schedule-edit-body">
                    <div class="work-schedule-section" id="section1">
                        ...
                        <div class="row work-schedule-row">
                            <div class="form-group col-lg-4 col-md-6 col-12">
                                ...
                                <select name="day_id"
                                    ...
                                    @foreach($days as $day)
                                        <option value="{{ $day->id }}" @if($work->day_id == $day->id) selected @endif>
                                            {{ $day->day_ar }}
                                        </option>
                                    @endforeach
                                </select>
            ...
            $.ajax({
                ...
                success: function(result){
                    if(result.status == true){
                        $('#section1').append(`
                        <div class="row work-schedule-row mt-4" id="remov${id}">
                            <div class="form-group col-lg-4 col-md-6 col-12">
                                <label>اليوم <span class="text-danger">*</span></label>
                        ...
                        <span class="work-schedule-remove-btn" onclick="removef(${id})">

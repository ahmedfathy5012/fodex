...
<!--        <select name="seller_id" class="form-control selectpicker" required="required" id="seller_id" data-live-search="true">-->
<!--          @foreach($sellers as $seller)-->
<!--          <option value="{{$seller->id}}" -->
<!--            @if($work->seller_id == $seller->id) selected @endif>{{$seller->name}}</option>-->
<!--          @endforeach-->
<!--        </select>-->
<!--       @error('seller_id')-->
 ...
 <div class="row" style="position: relative;">
  <div class="form-group col-lg-4 col-md-6">
        ...
        <select name="day_id" class="form-control selectpicker" required="required"   data-live-search="true">
          @foreach($days as $day)
          <option value="{{$day->id}}" @if($work->day_id == $day->id) selected @endif>{{$day->day_ar}}</option>
          @endforeach
        </select>
       @error('seller_id')
       <p style="color:red;">{{$message}}</p>
  ...
  <div class="form-group col-3">
    ...
    <input type="time" class="form-control " value="{{$work->work_from}}" name="from"  required="required"/>
    @error('from')
    <p style="color:red;">{{ $message }}</p>
 @enderror
   </div>    
   <div class="form-group col-3">
    ...
    <input type="time" class="form-control " value="{{$work->work_to}}" name="to"  required="required"/>
    @error('to')
    <p style="color:red;">{{ $message }}</p>
 @enderror
   </div>   

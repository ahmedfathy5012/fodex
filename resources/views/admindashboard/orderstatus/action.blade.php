<a href="{{route('orderstatus.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deleteorderstatus({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">

...
?>
<a href="{{route('edit_seller_items',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deleteitem({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
    ...
    <label>
        <input type="checkbox"  name="available" onchange="availableitem({{$id}})" 
        ...
        <span></span>
                                 ...
                                 @if($item->appear == 0)
                            <span class="btn btn-primary" onclick="hide({{$id}})" > ظهور</span>
                            @else
                            <!-- Trigger the modal with a button -->
<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#myModal{{$id}}">اخفاء</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <div class="row">
           <input type="button"  onclick="hide({{$id}})" class="btn btn-sm btn-primary mr-4" value="حفظ">
       </div>
      </div>
    </div>

        ...
        <form method="post" action="{{ $store_route }}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="mx-auto col-4">
                        ...
                        <label id="label" for="gallery-photo-add"><svg xmlns="http://www.w3.org/2000/svg" width="20"
            ...
            <div class='row'>
                ...
                <div class="form-group col-6">
                    ...
                    <input type="number" class="form-control " value="0" name="prepare_time" required="required" />
                    @error('prepare_time')
                        <p style="color:red;">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="form-group col-6">
                    ...
                    <select name="category_id" class="form-control selectpicker" onchange="filter_subcategories(this)"
                        required="required" id="category_id" required="required" data-live-search="true">
            ...
            <div class="col-4 mx-auto mb-5 mt-5">
                <button type="button" id="adds"
                    class="btn btn-success btn-light-success  w-100 d-flex justify-content-center align-items-center">
                    اضافه اكسترا
                </button>
            </div>
     ...
     <div class="form-group col-1 mt-4">
        <button class="btn btn-sm  font-weight-bolder btn-light-danger" type="button" onclick="removec(${id2})">مسح</button>
            ...
            function imageIsLoaded(e) {
                ...
                $('#row').append(
                    '<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 d-flex align-items-center"><figure class="imghvr-fade"><img style="width:100px;height:100px;"src=' +
                    e.target.result + '></figure></div>');
            };

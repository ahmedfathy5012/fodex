...
@section('content')
    <style>
        .seller-item-create-page { direction: rtl; }
        ...
        .seller-item-create-page .form-group label {
            font-weight: 700;
            color: #3f4254;
            margin-bottom: 8px;
            font-size: 14px;
        ...
        .seller-item-create-page .form-control,
        .seller-item-create-page .bootstrap-select > .dropdown-toggle {
            min-height: 44px;
        ...
        .seller-item-create-page .form-control:focus,
        .seller-item-create-page .bootstrap-select.show > .dropdown-toggle {
            border-color: #3699ff !important;
            box-shadow: 0 0 0 3px rgba(54,153,255,.12) !important;
        }

        .seller-item-create-page textarea.form-control {
            min-height: 125px;
            resize: vertical;
        }

        .seller-item-create-page .bootstrap-select .filter-option {
            text-align: right !important;
        }

        .seller-item-create-page .dropdown-menu {
            border-radius: 12px;
            border: 1px solid #edf0f5;
            box-shadow: 0 10px 26px rgba(0,0,0,.12);
        }

        .seller-item-create-page .text-danger,
        .seller-item-create-page p[style*="color:red"] {
        ...
        .seller-item-create-page .upload-zone {
        ...
        .seller-item-create-page .upload-zone.drag-over {
            border-color: #3699ff;
            background: #e8f3ff;
        }

        .seller-item-create-page .upload-zone__icon {
            color: #b5b5c3;
            margin-bottom: 1rem;
            transition: color 0.2s ease;
        }

        .seller-item-create-page .upload-zone.drag-over .upload-zone__icon {
            color: #3699ff;
        }

        .seller-item-create-page .upload-zone__title {
            font-size: 1rem;
            font-weight: 600;
            color: #3f4254;
        ...
        .seller-item-create-page .upload-zone__subtitle {
            font-size: 0.85rem;
            color: #b5b5c3;
            margin-bottom: 0.75rem;
        }

        .seller-item-create-page .upload-zone__btn {
            background: #3699ff;
            color: #fff;
            border: none;
            border-radius: 6px;
        ...
        .seller-item-create-page .upload-zone__btn:hover {
            background: #187de4;
        }

        .seller-item-create-page .upload-zone__hint {
            font-size: 0.78rem;
            color: #b5b5c3;
            margin: 0;
        }

        .seller-item-create-page .upload-zone__label {
            position: absolute;
            top: -0.65rem;
            right: 1rem;
            background: #f9f9fc;
        ...
        .seller-item-create-page .upload-zone__preview {
            margin-top: 1.25rem;
            padding-top: 1.25rem;
            border-top: 1px solid #ebebeb;
        }

        .seller-item-create-page .upload-zone__preview-inner {
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        .seller-item-create-page .upload-zone__preview-img {
            max-width: 100%;
            max-height: 200px;
            border-radius: 8px;
            object-fit: contain;
        ...
        .seller-item-create-page .upload-zone__remove {
            background: none;
        ...
        .seller-item-create-page .upload-zone__remove:hover {
            background: #f64e60;
            color: #fff;
        }
    ...
    <div class="seller-item-create-page">
        <div class="card card-custom seller-item-card">
            <div class="card-header">
                ...
                <span class="card-icon">
                    ...
                    <h3 class="card-label">إضافة منتج</h3>
                </div>
            </div>

            <form method="post" action="{{ $store_route }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-body seller-item-body">
                    <div class="seller-item-section">
                        ...
                        <div class="row seller-item-product-images" id="row"></div>
                    </div>
                    ...
                    <div class="seller-item-section">
                        ...
                        <section id="section1" class="seller-item-dynamic-section"></section>
                    </div>

                    <div class="seller-item-section">
                        <div class="seller-item-section-title">الاضافات</div>
                        <section id="section2" class="seller-item-dynamic-section"></section>
                    </div>
                </div>

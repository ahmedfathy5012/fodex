<a href="{{route('collectionstypes.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletecollectionstypes({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">

<a href="{{route('refusedreasons.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deleterefusedreasons({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">

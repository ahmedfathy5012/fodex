<a href="{{route('country.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletecountry({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
                             ...
                             <a href="{{route('country_states',$id)}}">
                                <img src="{{asset('state.png')}}" class="order_icon" title="المحافظات">
                            </a>
                            <script>

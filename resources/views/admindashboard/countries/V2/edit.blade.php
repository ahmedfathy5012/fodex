...
@section('content')
    <style>
        ...
        .country-edit-card .card-header {
            background: #ffffff;
            border-bottom: 1px solid #edf0f5;
            padding: 22px 26px;
        }

        .country-edit-card .card-title {
            margin: 0;
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        /*.country-edit-card .card-icon svg path,*/
        /*.country-edit-card .card-icon svg polygon {*/
        ...
        .country-edit-page .form-group label {
            font-weight: 700;
            color: #3f4254;
            margin-bottom: 8px;
            font-size: 14px;
        ...
        .country-edit-page .form-control,
        .country-edit-page .bootstrap-select > .dropdown-toggle {
            min-height: 44px;
        ...
        .country-edit-page .form-control:focus,
        .country-edit-page .bootstrap-select.show > .dropdown-toggle {
            border-color: #3699ff !important;
            box-shadow: 0 0 0 3px rgba(54, 153, 255, 0.12) !important;
        }

        .country-edit-page .bootstrap-select .filter-option {
            text-align: right !important;
        }

        .country-edit-page .dropdown-menu {
            border-radius: 12px;
            border: 1px solid #edf0f5;
            box-shadow: 0 10px 26px rgba(0, 0, 0, 0.12);
        }

        .country-edit-page .text-danger,
        .country-edit-page p[style*="color:red"] {
    ...
    <div class="country-edit-page">
        <div class="card card-custom country-edit-card">
            <div class="card-header">
                ...
                <span class="card-icon">
                    ...
                    <h3 class="card-label">تعديل دولة</h3>
                </div>
            </div>
            ...
            <form method="post" action="{{ route('country.update', $country->id) }}">
                ...
                <div class="card-body country-edit-body">
                    <div class="country-section">
                        <div class="country-section-title">بيانات الدولة</div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6 col-md-6">
                                <label>العمله <span class="text-danger">*</span></label>
                                <select name="coin_id"
                                        class="form-control selectpicker"
                                        required="required"
                                        data-live-search="true">
                                    @foreach($coins as $coin)
                                        <option value="{{ $coin->id }}" @if($country->coin_id == $coin->id) selected @endif>
                                            {{ $coin->title }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="country-section">
                        <div class="country-section-title">تحديد الدولة على الخريطة</div>

                        <div class="country-map-note">
                            يمكنك تعديل حدود الدولة الحالية أو رسم حدود جديدة باستخدام أداة Polygon.
                        </div>
                ...
                <div class="country-submit-wrapper">
                    <button type="submit" class="btn btn-shadow btn-primary font-weight-bold country-submit-btn">
                        تعديل
...
@section('scripts')
    ...
    <script>
        ...
        function draw_shape() {
            ...
            var latlngsObj = JSON.parse(country.text);

            var savedPolygon = new google.maps.Polygon({
                paths: latlngsObj,
                strokeColor: "#3699ff",
                strokeOpacity: 0.9,
                strokeWeight: 3,
            ...
            google.maps.event.addListener(savedPolygon, 'click', function() {
                setSavedAreaSelectionSelection(country, this);
                syncShapePoints(this);
            });

            google.maps.event.addListener(savedPolygon.getPath(), 'set_at', function() {
                syncShapePoints(savedPolygon);
            });

            google.maps.event.addListener(savedPolygon.getPath(), 'insert_at', function() {
                syncShapePoints(savedPolygon);
            });
            ...
            latlngsObj.forEach(function(point) {

...
@section('content')
    <style>
        ...
        .country-create-card .card-header {
            background: #ffffff;
            border-bottom: 1px solid #edf0f5;
            padding: 22px 26px;
        }

        .country-create-card .card-title {
            margin: 0;
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        .country-create-card .card-label {
            margin: 0;
            font-size: 20px;
            font-weight: 800;
            color: #181c32;
        ...
        /*.country-create-card .card-icon svg path,*/
        /*.country-create-card .card-icon svg polygon {*/
        ...
        .country-create-page .form-group label {
            font-weight: 700;
            color: #3f4254;
            margin-bottom: 8px;
            font-size: 14px;
        ...
        .country-create-page .form-control,
        .country-create-page .bootstrap-select > .dropdown-toggle {
            min-height: 44px;
        ...
        .country-create-page .form-control:focus,
        .country-create-page .bootstrap-select.show > .dropdown-toggle {
            border-color: #3699ff !important;
            box-shadow: 0 0 0 3px rgba(54, 153, 255, 0.12) !important;
        }

        .country-create-page .bootstrap-select .filter-option {
            text-align: right !important;
        }

        .country-create-page .dropdown-menu {
            border-radius: 12px;
            border: 1px solid #edf0f5;
            box-shadow: 0 10px 26px rgba(0, 0, 0, 0.12);
        }

        .country-create-page .text-danger,
        .country-create-page p[style*="color:red"] {
    ...
    <div class="country-create-page">
        <div class="card card-custom country-create-card">
            <div class="card-header">
                ...
                <span class="card-icon">
                    ...
                    <h3 class="card-label">إضافة دولة</h3>
                </div>
            </div>
            ...
            <form method="post" action="{{ route('country.store') }}">
                ...
                <div class="card-body country-create-body">
                    ...
                    <div class="country-section">
                        ...
                        <div class="country-map-note">
                            ارسم حدود الدولة باستخدام أداة Polygon، ويمكنك تحديد الشكل وحذفه ثم رسمه مرة أخرى.
                        </div>

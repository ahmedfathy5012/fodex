<!--<a href="{{route('expensedriver.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">-->
...
<!--                            </a>-->
                            ...
                            <div style="cursor:pointer;" onclick="deleteexpensedriver({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
                            ...
                            <script>
              function deleteexpensedriver(sel){
    let id = sel;
 console.log(sel);

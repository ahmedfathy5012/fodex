...
<form method="post" action="{{route('seller.update',$seller->id)}}" enctype="multipart/form-data">
 ...
 <div class="row" id="row">
     ...
     <div class="col-xl-4 col-6 col-sm-12 d-flex align-items-center"><figure class="imghvr-fade">
         <img style="width:100px;height:100px;"src="{{asset('uploads/'.$image->image)}}"></figure></div>
     @endforeach
     @endif
</div>
  <div class="row">
     ...
     <!--   @if($contract) style="background-image:url({{asset('uploads/'. $contract->paper_contract_image)}})" @endif></div>-->
     ...
     <!--  </div>-->
     <!--</div>-->
 <div class="col-5"><div class="image-input image-input-outline image-input-circle" id="kt_image_2">
        <div class="image-input-wrapper mb-5" id="im2"  style="background-image:url({{asset('uploads/'. $seller->logo)}})"></div>
     ...
     @enderror
        ...
        <div class="image-input-wrapper mb-5" id="im1"  style="background-image:url({{asset('uploads/'. $seller->cover)}})"></div>
...
<div class="row"><div class="col-4"><label>المعلومات الرئسيه</label>
   ...
   <div class="form-group col-6">
    ...
    <input type="text" class="form-control " value="{{$seller->name}}" name="name"  required="required"/>
    @error('name')
    <p style="color:red;">{{ $message }}</p>
 @enderror
   </div>   
  <div class="form-group col-6">
    ...
    <input type="text" class="form-control " value="{{$seller->phone}}" name="phone" required="required" />
    @error('phone')
    <p style="color:red;">{{ $message }}</p>
 @enderror
 ...
 @enderror
   ...
   <div class="form-group col-6">
        ...
        <select name="major_id" class="form-control selectpicker" onchange="getsubcategories(this)" id="major" required="required" data-live-search="true">
          ...
          <option value="{{$major->id}}" @if($seller->major_id == $major->id) selected @endif >{{$major->title}}</option>
          @endforeach
        </select>
       @error('major_id')
       <p style="color:red;">{{$message}}</p>
  ...
  <input type="radio"  name="is_subcategory" value="0" @if($seller->is_subcategory == 0) checked @endif >
  <span class="checkmark"></span>
</label>
<label class="container">subcategory
  <input type="radio" name="is_subcategory" value="1" @if($seller->is_subcategory == 1) checked @endif>
  <span class="checkmark"></span>
</label>
</div>
       <!--<div class="form-group col-6">-->
       ...
       <!--   <option value="{{$category->id}}" @if($seller->categories->pluck('id')->contains($category->id))  selected @endif>{{$category->title}}</option>-->
       <!--   @endforeach-->
       <!-- </select>-->
       <!--@error('category_id')-->
       <!--<p style="color:red;">{{$message}}</p>-->
       ...
       <!--</div>    -->
        ...
        <select name="tag_id[]" multiple class="form-control " id="tag_id"  data-live-search="true">
          @foreach($tags as $tag)
          <option value="{{$tag->id}}" @if($seller->tags->pluck('id')->contains($tag->id))  selected @endif>{{$tag->title}}</option>
          @endforeach
        </select>
       @error('tag_id')
       <p style="color:red;">{{$message}}</p>
    ...
    <input type="number" class="form-control " value="{{$seller->prepare_time}}" name="prepare_time"  required="required"/>
    @error('prepare_time')
    <p style="color:red;">{{ $message }}</p>
 @enderror
   </div>   
        ...
        <select name="payment_id[]" class="form-control selectpicker" multiple  data-live-search="true">
          ...
          <option value="{{$payment->id}}" @if($seller->payments->pluck('id')->contains($payment->id))  selected @endif>{{$payment->title}}</option>
          @endforeach
        </select>
       @error('payment_id')
       <p style="color:red;">{{$message}}</p>
    ...
    <input type="number" class="form-control " value="{{$seller->min_order}}" name="min_order"  required="required"/>
    @error('min_order')
    <p style="color:red;">{{ $message }}</p>
 @enderror
   </div>  
 ...
 @enderror
    ...
    <input type="number" class="form-control " value="{{$seller->delivery_money}}" name="delivery_money"  />
 ...
 <div class="form-group col-6">
    ...
    <input type="text" class="form-control " @if($address) value="{{$address->street}}" @endif name="street"  required="required"/>
    @error('street')
    <p style="color:red;">{{ $message }}</p>
 @enderror
   </div>    
   <div class="form-group col-6">
    ...
    <input type="text" class="form-control " @if($address)  value="{{$address->address}}" @endif name="address"  required="required"/>
    @error('address')
    <p style="color:red;">{{ $message }}</p>
 @enderror
  </div>  
 ...
 <!--   <input type="number" class="form-control " @if($address) value="{{$address->building_number}}" @endif name="building_number"  required="required"/>-->
 <!--   @error('building_number')-->
 <!--   <p style="color:red;">{{ $message }}</p>-->
 <!--@enderror-->
 <!--  </div>     <div class="form-group col-6">-->
 <!--   <label>رقم الطابق     <span class="text-danger">*</span></label>-->
 <!--   <input type="number" class="form-control " @if($address) value="{{$address->floor_number}}" @endif name="floor_number"  required="required"/>-->
 <!--   @error('floor_number')-->
 <!--   <p style="color:red;">{{ $message }}</p>-->
 <!--@enderror-->
 <!--  </div>  -->
    ...
    <input type="number" class="form-control " value="{{$seller->distance_range}}" name="distance_range"  required="required"/>
 ...
 <!--   <input type="number" class="form-control " @if($contract) value="{{$contract->percentage}}" @endif name="percentage"  required="required"/>-->
 <!--   @error('percentage')-->
 <!--   <p style="color:red;">{{ $message }}</p>-->
 <!--@enderror-->
 <!--  </div> -->

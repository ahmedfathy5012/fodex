...
?>
<a href="{{route('editsellercontract',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletesellercontract({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
                     ...
                     <span class="btn btn-danger" onclick="activesellercontract({{$id}})">الغاء التفعيل</span>
                     @else
                 <span class="btn btn-primary" onclick="activesellercontract({{$id}})">تفعيل </span>
                     @endif

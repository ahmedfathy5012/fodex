...
<form method="post" action="{{route('updatesellercontract',$contract->id)}}" enctype="multipart/form-data">
  ...
  <div class="form-group col-lg-4 col-md-12">
    ...
    <input type="date" class="form-control " value="{{$contract->from_day}}" name="from_day"  required="required"/>
    @error('from_day')
    <p style="color:red;">{{ $message }}</p>
 @enderror
   </div> <div class="form-group col-lg-4 col-md-12">
    <label>تاريخ العمل  الى      <span class="text-danger">*</span></label>
    <input type="date" class="form-control " value="{{$contract->to_day}}" name="to_day"  required="required"/>
    @error('to_day')
    <p style="color:red;">{{ $message }}</p>
 @enderror
   </div> <div class="form-group col-lg-4 col-md-12">
    <label>النسبه المئويه         <span class="text-danger">*</span></label>
    <input type="number" class="form-control " value="{{$contract->percentage}}" name="percentage"  required="required"/>
    @error('percentage')
    <p style="color:red;">{{ $message }}</p>
 @enderror
   </div> 

...
<div class="row">
    <div class="col-3"></div>
     ...
     <div class="col-3">
         <input type="button" onclick="addcollection({{$id}},{{$collect->ordersnumber}})" value="حفظ" class="form-control btn btn-success btn-sm m-4">
     </div>
      </div>
...
<div class="row">
    ...
    <input type="hidden" id="{{$countorders}}" value="{{$a}}">
     <div class="col-3">
         <input type="button" onclick="addcollection({{$id}},{{$countorders}})" value="حفظ" class="form-control btn btn-success btn-sm m-4">
     </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>

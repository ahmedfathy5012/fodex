...
<div class="btns{{ $id }} btn_container">
    @php
        ...
        // if (isset($collect)) {
        //     $orders = $seller->orders->where('status', 1)->whereBetween('created_at', [$collect->created_at, now()]);
        //     $countorders = count($orders);
        //     $money = array_sum($orders->pluck('priceafterdiscount')->toArray());
        //     $value = $money * ($seller->commission / 100) + $collect->money_left;
        // } else {
        //     $orders = $seller->orders->where('status', 1);
        //     $countorders = count($orders);
        //     $money = array_sum($orders->pluck('priceafterdiscount')->toArray());
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="number" required value="{{ $countorders }}" min="1"
                                name="orders" id="orders{{ $id }}" class="form-control">
                        </div>
                        <div class="col-6">

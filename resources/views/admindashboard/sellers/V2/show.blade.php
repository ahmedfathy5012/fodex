							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5"> {{$seller->name}}</h5>
										<!--end::Page Title-->
									...
									<div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="left">
										...
										<div class="dropdown-menu dropdown-menu-md dropdown-menu-right p-0 m-0">
											...
											<ul class="navi navi-hover">
												...
												<li class="navi-item">
													<a href="{{route('orderitemseller',$seller->id)}}"  class="navi-link">
														<span class="navi-text">
															<span class="label label-xl label-inline label-light-success">تفاصيل الطلبات</span>
														</span>
													</a>
												</li>
												<li class="navi-item">
													<a href="{{route('sellercontracts',$seller->id)}}"  class="navi-link">
														<span class="navi-text">
												...
												<li class="navi-item">
													<a href="{{route('sellercategory',$seller->id)}}" class="navi-link">
														<span class="navi-text">
															<span class="label label-xl label-inline label-light-danger">categories</span>
														</span>
													</a>
												</li>
												<li class="navi-item">
													<a href="{{route('sellerworkschedule.index',$seller->id)}}"  class="navi-link">
														<span class="navi-text">
															<span class="label label-xl label-inline label-light-warning">workschedule</span>
														</span>
													</a>
												</li>
												<li class="navi-item">
													<a href="{{route('itemseller',$seller->id)}}" class="navi-link">
														<span class="navi-text">
															<span class="label label-xl label-inline label-light-primary">show items</span>
														</span>
													</a>
												</li>
												<!--<li class="navi-item">-->
										...
										<div class="d-flex mb-9">
											...
											<div class="flex-shrink-0 mr-7 mt-lg-0 mt-3">
												<div class="symbol symbol-50 symbol-lg-120">
													...
													<img src="{{asset('uploads/'.$seller->image->image)}}" alt="image" />
													@else
													لا يوجد صوره
													@endif
											...
											<div class="flex-grow-1">
												...
												<div class="d-flex justify-content-between flex-wrap mt-1">
													<div class="d-flex mr-3">
														<a href="{{route('seller.show',$seller->id)}}" class="text-dark-75 text-hover-primary font-size-h5 font-weight-bold mr-3">{{$seller->name}}</a>
														<a href="#">
                                                    ...
                                                    <div class="my-lg-0 my-3">
                                                        <a href="{{ route('seller.edit', $seller->id) }}"
                                                           class="btn btn-sm seller-profile-edit-btn">
                                                            تعديل
                                                        </a>
                                                    </div>
												</div>
												...
												<div class="d-flex flex-wrap justify-content-between mt-1">
													<div class="d-flex flex-column flex-grow-1 pr-8">
														<div class="d-flex flex-wrap mb-4">
															...
															<i class="flaticon2-new-email mr-2 font-size-lg"></i>{{$seller->name}}</span>
															<a href="#" class="text-dark-50 text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
															<i class="flaticon2-calendar-3 mr-2 font-size-lg"></i>{{$seller->phone}}</a>
															<!--<a href="#" class="text-dark-50 text-hover-primary font-weight-bold">-->
															<!--<i class="flaticon2-placeholder mr-2 font-size-lg"></i></a>-->
														</div>
														<span class="font-weight-bold text-dark-50">{{$seller->description}}</span>
												...
												<div class="row">
												      <?php
    $res = \App\Models\Seller::where('id',$seller->id)->first();
    $collect = \App\Models\AllCollection::where('seller_id',$seller->id)->latest()->first();
    // if(isset($collect)){
...
$aa = [];
    ...
    $date3 = \Carbon\Carbon::parse($a)->format('Y-m');
        $collect = \App\Models\AllCollection::where('seller_id',$seller->id)->where('month_date',$a)
        ->first();?>
    @if($collect)
    @if($collect->money_left == 0)
    @else
      <span class="badge badge-primary mt-2 ml-2" data-toggle="modal" data-target="#myModale{{$a}}" style="cursor:pointer;">{{$a}}</span>
...
<div class="row">
    <div class="col-3"></div>
     ...
     <div class="col-3">
         <input type="button" onclick="addcollection({{$seller->id}},{{$collect->ordersnumber}})" value="حفظ" class="form-control btn btn-success btn-sm m-4">
     </div>
      </div>
    ...
    //   ->whereMonth('orders.created_at',$date3)->get();
       ...
       $contract =  \App\Models\Sellercontract::where('seller_id',$seller->id)->where('active',1)->latest()->first();
...
@if($countorders == 0)
@else
          <span class="badge badge-success mt-2 ml-2" data-toggle="modal" data-target="#myModal{{$a}}" style="cursor:pointer;">{{$a}}</span>
...
<div class="row">
    ...
    <input type="hidden" id="{{$countorders}}" value="{{$a}}">
     <div class="col-3">
         <input type="button" onclick="addcollection({{$seller->id}},{{$countorders}})" value="حفظ" class="form-control btn btn-success btn-sm m-4">
     </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
										...
										<div class="d-flex align-items-center flex-wrap mt-8">
											...
											<div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
												...
												<div class="d-flex flex-column text-dark-75">
													<span class="font-weight-bolder font-size-sm">مبلغ الطلبات الكلى</span>
													<span class="font-weight-bolder font-size-h5">
													<span class="text-dark-50 font-weight-bold"></span>{{array_sum($seller->orders->pluck('priceafterdiscount')->toArray())}}</span>
												</div>
											</div>
											<!--end::Item-->
											<!--begin::Item-->
											<div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
												...
												<div class="d-flex flex-column text-dark-75">
													<span class="font-weight-bolder font-size-sm">المبلغ المحصل</span>
													<span class="font-weight-bolder font-size-h5">
													<span class="text-dark-50 font-weight-bold"></span>{{array_sum($seller->allcollection->pluck('money_taken')->toArray())}}</span>
												</div>
											</div>
											<!--end::Item-->
											<!--begin::Item-->
											<div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
												...
												<div class="d-flex flex-column text-dark-75">
													<span class="font-weight-bolder font-size-sm">محفظه المطعم</span>
													<span class="font-weight-bolder font-size-h5">
													<span class="text-dark-50 font-weight-bold"></span>{{array_sum($seller->orders->pluck('priceafterdiscount')->toArray()) - array_sum($seller->allcollection->pluck('money_taken')->toArray())}}</span>
												</div>
											</div>
											<!--end::Item-->
											<!--begin::Item-->
											<div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
												...
												<div class="d-flex flex-column flex-lg-fill">
													<span class="text-dark-75 font-weight-bolder font-size-sm">{{count($seller->orders)}} طلب</span>
													<a href="{{route('sellerorders',$seller->id)}}" class="text-primary font-weight-bolder">اظهار</a>
												</div>
											</div>
								<!--end::Item-->
											<!--begin::Item-->
...
@endsection
<style>
    /* Seller show page modern style - no logic changes */
    ...
    /*#kt_subheader .btn-icon svg path,*/
    /*#kt_subheader .btn-icon svg polygon {*/
    /*    fill: #3699ff !important;*/
    /*}*/

    .seller-profile-edit-btn {
        min-width: 90px;
        height: 38px;
    ...
    .seller-profile-edit-btn:hover {
        background: #3699ff !important;
        color: #ffffff !important;
    }


    #kt_subheader .dropdown-menu {
        border: 0;
        border-radius: 14px;
    ...
    #kt_subheader .navi-link {
        border-radius: 10px;
        padding: 8px 10px;
    }

    #kt_subheader .navi-link:hover {
        background: #f3f9ff;
    }
    ...
    #new > .card.card-custom > .card-body {
    ...
    #new .flaticon2-correct {
        color: #1bc5bd !important;
    }

    #new .btn-light-success {
        min-width: 90px;
        height: 38px;
        border-radius: 10px !important;
    ...
    #new .font-weight-bold.text-dark-50 {
        display: block;
        margin-top: 8px;
        line-height: 1.8;
    ...
    #new .d-flex.align-items-center.flex-lg-fill {
        background: #ffffff;
        border: 1px solid #edf0f5;
        border-radius: 14px;
        padding: 16px;
    ...
    #new .d-flex.align-items-center.flex-lg-fill i {
        color: #3699ff !important;
        opacity: 1 !important;
    }

    #new .d-flex.align-items-center.flex-lg-fill .font-size-sm {
        color: #7e8299 !important;
        font-weight: 800 !important;
        margin-bottom: 4px;
    }

    #new .d-flex.align-items-center.flex-lg-fill .font-size-h5 {
        color: #181c32 !important;
    ...
    #new .modal-body .form-control:focus {
        border-color: #3699ff;
    ...
    #new input[type="button"].btn-success,
    #new .modal-body .btn-success {
        min-width: 120px;
        height: 40px;
        border-radius: 10px !important;
        background: #1bc5bd !important;
    ...
    /* Hide empty placeholder widget rows after seller card */
    #new + .row,
    #new + .row + .row {
 ...
 $.ajaxSetup({
   ...
   //    contentType: "application/json; charset=utf-8",
       ...
       success: function(result){
        ...
        $("#new").load(`https://fodex.dawena.net/public/seller/${id} #new`);
           }
       }
  })
}

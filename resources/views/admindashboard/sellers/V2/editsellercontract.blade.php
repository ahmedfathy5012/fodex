...
@section('content')
    <style>
        .seller-contract-edit-page {
            direction: rtl;
        }

        .seller-contract-edit-card {
            border: 0;
            border-radius: 16px;
            overflow: hidden;
            background: #ffffff;
        ...
        .seller-contract-edit-card .card-header {
            background: #ffffff;
            border-bottom: 1px solid #edf0f5;
            padding: 22px 26px;
        }

        .seller-contract-edit-card .card-title {
            margin: 0;
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        .seller-contract-edit-card .card-label {
            margin: 0;
            font-size: 20px;
            font-weight: 800;
            color: #181c32;
        ...
        .seller-contract-edit-card .card-icon {
            width: 42px;
            height: 42px;
            border-radius: 12px;
            background: #eaf4ff;
        ...
        .seller-contract-edit-card .card-icon svg path,
        .seller-contract-edit-card .card-icon svg polygon,
        .seller-contract-edit-card .card-icon svg rect,
        .seller-contract-edit-card .card-icon svg circle {
            fill: #3699ff !important;
        }

        .seller-contract-edit-body {
            padding: 28px;
            background: #ffffff;
        }
        ...
        .seller-contract-edit-page .form-group label,
        ...
        .seller-contract-edit-page .form-control {
            min-height: 44px;
            border-radius: 10px;
        ...
        .seller-contract-edit-page .form-control:focus {
            border-color: #3699ff;
            box-shadow: 0 0 0 3px rgba(54, 153, 255, 0.12) !important;
        }

        .seller-contract-edit-page textarea.form-control {
            min-height: 120px;
            resize: vertical;
        }
        ...
        .seller-contract-edit-page .image-input {
            width: 100%;
            display: flex;
            flex-direction: column;
            align-items: center;
        ...
        .seller-contract-edit-page .image-input-wrapper {
        ...
        .seller-contract-edit-page .text-danger,
        .seller-contract-edit-page p[style*="color:red"] {
    ...
    <div class="seller-contract-edit-page">
        <div class="card card-custom seller-contract-edit-card">
            ...
            <div class="card-header">
                ...
                <span class="card-icon">
                    ...
                    <h3 class="card-label">تعديل عقد العمل</h3>
                </div>
            </div>

            <form method="post" action="{{ route('updatesellercontract', $contract->id) }}" enctype="multipart/form-data">
                @csrf

                <div class="card-body seller-contract-edit-body">
                            ...
                            <div class="col-lg-6 col-md-12 mx-auto seller-contract-upload-wrapper">
                                <div class="seller-contract-upload-box">
                                    <div class="image-input image-input-outline image-input-circle" id="kt_image_3">
                                        ...
                                        <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow p-5 seller-contract-upload-btn"
                                               data-action="change"
                                               data-toggle="tooltip"
                                               title=""

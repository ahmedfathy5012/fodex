<a href="{{route('problem_reasons.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deleteproblem_reasons({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
                            ...
                            <script>
              function deleteproblem_reasons(sel){
    let id = sel;
 console.log(sel);

...
@section('content')
    <style>
        ...
        .notification-send-card .card-header {
            background: #ffffff;
            border-bottom: 1px solid #edf0f5;
            padding: 22px 26px;
        }

        .notification-send-card .card-title {
            margin: 0;
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        .notification-send-card .card-label {
            margin: 0;
            font-size: 20px;
            font-weight: 800;
            color: #181c32;
        ...
        .notification-send-card .card-icon {
            width: 42px;
            height: 42px;
            border-radius: 12px;
            background: #eaf4ff;
        ...
        /*.notification-send-card .card-icon svg path,*/
        /*.notification-send-card .card-icon svg polygon {*/
        ...
        .notification-send-page .form-group label {
            font-weight: 700;
            color: #3f4254;
            margin-bottom: 8px;
            font-size: 14px;
        ...
        .notification-send-page .form-control,
        .notification-send-page .bootstrap-select > .dropdown-toggle {
            min-height: 44px;
        ...
        .notification-send-page .form-control:focus,
        .notification-send-page .bootstrap-select.show > .dropdown-toggle {
            border-color: #3699ff !important;
            box-shadow: 0 0 0 3px rgba(54, 153, 255, 0.12) !important;
        }

        .notification-send-page .bootstrap-select .filter-option {
            text-align: right !important;
        }

        .notification-send-page .dropdown-menu {
            border-radius: 12px;
            border: 1px solid #edf0f5;
            box-shadow: 0 10px 26px rgba(0, 0, 0, 0.12);
        }

        .notification-send-page .text-danger {
            color: #f64e60 !important;
        }

        .notification-submit-wrapper {
            display: flex;
            justify-content: center;
            padding: 0 28px 28px;
        }
        ...
        .notification-submit-btn svg path {
    ...
    <div class="notification-send-page">
        <div class="card card-custom notification-send-card">
            <div class="card-header">
                ...
                <span class="card-icon">
                    ...
                    <h3 class="card-label">إرسال إشعارات</h3>
                </div>
            </div>

            <div class="card-body notification-send-body">
                <div class="notification-section">
                    <div class="notification-section-title">تحديد الجمهور المستهدف</div>
                ...
                <div class="notification-section">
                    <div class="notification-section-title">بيانات الإشعار</div>
            ...
            <div class="notification-submit-wrapper">
                <button type="button"
                        class="btn btn-shadow btn-primary font-weight-bold notification-submit-btn"

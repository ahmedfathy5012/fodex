...
@section('content')
    <style>
        ...
        .city-create-card .card-header {
            background: #ffffff;
            border-bottom: 1px solid #edf0f5;
            padding: 22px 26px;
        }

        .city-create-card .card-title {
            margin: 0;
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        /*.city-create-card .card-icon svg path,*/
        /*.city-create-card .card-icon svg polygon {*/
        ...
        .city-create-page .form-group label {
            font-weight: 700;
            color: #3f4254;
            margin-bottom: 8px;
            font-size: 14px;
        ...
        .city-create-page .form-control,
        .city-create-page .bootstrap-select > .dropdown-toggle {
            min-height: 44px;
        ...
        .city-create-page .form-control:focus,
        .city-create-page .bootstrap-select.show > .dropdown-toggle {
            border-color: #3699ff !important;
            box-shadow: 0 0 0 3px rgba(54, 153, 255, 0.12) !important;
        }

        .city-create-page .bootstrap-select .filter-option {
            text-align: right !important;
        }

        .city-create-page .dropdown-menu {
            border-radius: 12px;
            border: 1px solid #edf0f5;
            box-shadow: 0 10px 26px rgba(0, 0, 0, 0.12);
        }

        .city-create-page .text-danger,
        .city-create-page p[style*="color:red"] {
    ...
    <div class="city-create-page">
        <div class="card card-custom city-create-card">
            <div class="card-header">
                ...
                <span class="card-icon">
                    ...
                    <h3 class="card-label">إضافة مدينة</h3>
                </div>
            </div>
            ...
            <form method="post" action="{{ route('city.store') }}">
                ...
                <div class="card-body city-create-body">
                    ...
                    <div class="city-section">
                        ...
                        <div class="city-map-note">
                            ارسم حدود المدينة باستخدام أداة Polygon، ويمكنك تحديد الشكل وحذفه ثم رسمه مرة أخرى.
                        </div>

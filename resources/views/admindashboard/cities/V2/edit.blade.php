...
@section('content')
    <style>
        ...
        .city-edit-card .card-header {
            background: #ffffff;
            border-bottom: 1px solid #edf0f5;
            padding: 22px 26px;
        }

        .city-edit-card .card-title {
            margin: 0;
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        /*.city-edit-card .card-icon svg path,*/
        /*.city-edit-card .card-icon svg polygon {*/
        ...
        .city-edit-page .form-group label {
            font-weight: 700;
            color: #3f4254;
            margin-bottom: 8px;
            font-size: 14px;
        ...
        .city-edit-page .form-control,
        .city-edit-page .bootstrap-select > .dropdown-toggle {
            min-height: 44px;
        ...
        .city-edit-page .form-control:focus,
        .city-edit-page .bootstrap-select.show > .dropdown-toggle {
            border-color: #3699ff !important;
            box-shadow: 0 0 0 3px rgba(54, 153, 255, 0.12) !important;
        }

        .city-edit-page .bootstrap-select .filter-option {
            text-align: right !important;
        }

        .city-edit-page .dropdown-menu {
            border-radius: 12px;
            border: 1px solid #edf0f5;
            box-shadow: 0 10px 26px rgba(0, 0, 0, 0.12);
        }

        .city-edit-page .text-danger,
        .city-edit-page p[style*="color:red"] {
    ...
    <div class="city-edit-page">
        <div class="card card-custom city-edit-card">
            <div class="card-header">
                ...
                <span class="card-icon">
                    ...
                    <h3 class="card-label">تعديل مدينة</h3>
                </div>
            </div>
            ...
            <form method="post" action="{{ route('city.update', $city->id) }}">
                ...
                <div class="card-body city-edit-body">
                    <div class="city-section">
                        <div class="city-section-title">بيانات المدينة</div>
                    ...
                    <div class="city-section">
                        <div class="city-section-title">تحديد المدينة على الخريطة</div>

                        <div class="city-map-note">
                            يمكنك تعديل حدود المدينة الحالية أو رسم حدود جديدة باستخدام أداة Polygon.
                        </div>
                ...
                <div class="city-submit-wrapper">
                    <button type="submit" class="btn btn-shadow btn-primary font-weight-bold city-submit-btn">
                        حفظ التعديل
...
@section('scripts')
    ...
    <script>
        ...
        function draw_shape() {
            var cityText = @json($city->text);

            if (!cityText) {
                return;
            }

            var latlngsObj = JSON.parse(cityText);
            ...
            google.maps.event.addListener(savedShape, 'click', function() {
                setSavedAreaSelectionSelection(this);
        ...
        function setSavedAreaSelectionSelection(shape) {
            clearSelection();
            selectedShape = shape;
            selectedArea = shape;
            shape.setEditable(true);

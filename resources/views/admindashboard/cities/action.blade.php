<a href="{{route('city.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletecity({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
                            ...
                            <a href="{{route('city_zones',$id)}}">
                                <img src="{{asset('location.png')}}" class="order_icon" title="المناطق">
                            </a>
                            <script>

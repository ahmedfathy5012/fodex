...
@section('content')
    <style>
        ...
        .offer-create-card .card-header {
            background: #ffffff;
            border-bottom: 1px solid #edf0f5;
            padding: 22px 26px;
        }

        .offer-create-card .card-title {
            margin: 0;
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        /*.offer-create-card .card-icon svg path,*/
        /*.offer-create-card .card-icon svg polygon {*/
        ...
        .offer-create-page .bootstrap-select > .dropdown-toggle {
            min-height: 44px;
        ...
        .offer-create-page .bootstrap-select.show > .dropdown-toggle {
            border-color: #3699ff !important;
            box-shadow: 0 0 0 3px rgba(54, 153, 255, 0.12) !important;
        }

        .offer-create-page .bootstrap-select .filter-option {
            text-align: right !important;
        }

        .offer-create-page .dropdown-menu {
            border-radius: 12px;
            border: 1px solid #edf0f5;
            box-shadow: 0 10px 26px rgba(0, 0, 0, 0.12);
        }

        .offer-create-page .text-danger,
        .offer-create-page p[style*="color:red"] {
        ...
        .offer-create-page .image-input-wrapper {
        ...
        .offer-create-page .image-input-wrapper::after {
            content: "صورة";
            position: absolute;
            inset: 0;
            display: flex;
        ...
        .offer-create-page .image-input-wrapper[style*="url"]::after {
            display: none;
        }

        .offer-create-page .image-input label.btn {
            position: absolute;
            right: -5px;
            bottom: 8px;
        ...
        /*.offer-create-page .image-input label.btn svg path,*/
        /*.offer-create-page .image-input label.btn svg rect,*/
        /*.offer-create-page .image-input label.btn svg circle {*/
        /*    fill: #3699ff !important;*/
        /*}*/

        .offer-create-page .image-input input[type="file"] {
            display: none;
        }
    ...
    <div class="offer-create-page">
        <div class="card card-custom offer-create-card">
            <div class="card-header">
                ...
                <span class="card-icon">
                    ...
                    <h3 class="card-label">إضافة عرض</h3>
                </div>
            </div>
            ...
            <form method="post"
                ...
                <div class="card-body offer-create-body">
                    <div class="offer-section">
                        <div class="offer-section-title">صورة العرض</div>
                            ...
                            <div>
                                <div class="image-input image-input-outline image-input-circle" id="kt_image_3">
                                    ...
                                    <span class="svg-icon svg-icon-primary svg-icon-2x">
                                        ...
                                        <input type="file" name="image" id="do4" required/>
                                ...
                                <span class="offer-image-label">صورة العرض</span>
                            </div>
                        </div>
                    </div>

                    <div class="offer-section">
                        <div class="offer-section-title">بيانات العرض</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="offer-paid-wrapper">
                                    <label class="offer-paid-box">
                ...
                <div class="offer-submit-wrapper">
                    <button type="submit" class="btn btn-shadow btn-primary font-weight-bold offer-submit-btn">
                        إضافة
        ...
        function readURL4(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    ...
                    $('#im4').css('background-position', 'center');
                    $('#im4').css('background-repeat', 'no-repeat');
                    $('#im4').css('background-size', 'cover');
                }

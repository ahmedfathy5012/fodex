...
@section('content')
    <style>
        ...
        .offer-edit-card .card-header {
            background: #ffffff;
            border-bottom: 1px solid #edf0f5;
            padding: 22px 26px;
        }

        .offer-edit-card .card-title {
            margin: 0;
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        /*.offer-edit-card .card-icon svg path,*/
        /*.offer-edit-card .card-icon svg polygon {*/
        ...
        .offer-edit-page .form-group label {
            font-weight: 700;
            color: #3f4254;
            margin-bottom: 8px;
            font-size: 14px;
        ...
        .offer-edit-page .form-control,
        .offer-edit-page .bootstrap-select > .dropdown-toggle {
            min-height: 44px;
        ...
        .offer-edit-page .form-control:focus,
        .offer-edit-page .bootstrap-select.show > .dropdown-toggle {
            border-color: #3699ff !important;
            box-shadow: 0 0 0 3px rgba(54, 153, 255, 0.12) !important;
        }

        .offer-edit-page .bootstrap-select .filter-option {
            text-align: right !important;
        }

        .offer-edit-page .dropdown-menu {
            border-radius: 12px;
            border: 1px solid #edf0f5;
            box-shadow: 0 10px 26px rgba(0, 0, 0, 0.12);
        }

        .offer-edit-page .text-danger,
        .offer-edit-page p[style*="color:red"] {
        ...
        .offer-edit-page .image-input-wrapper {
        ...
        .offer-edit-page .image-input label.btn {
            position: absolute;
            right: -5px;
            bottom: 8px;
        ...
        /*.offer-edit-page .image-input label.btn svg path,*/
        /*.offer-edit-page .image-input label.btn svg rect,*/
        /*.offer-edit-page .image-input label.btn svg circle {*/
        /*    fill: #3699ff !important;*/
        /*}*/

        .offer-edit-page .image-input input[type="file"] {
            display: none;
        }
    ...
    <div class="offer-edit-page">
        <div class="card card-custom offer-edit-card">
            ...
            <form method="post"
                ...
                <div class="card-body offer-edit-body">
                                ...
                                <select name="zone_id[]"
                                    ...
                                    @foreach($zones as $zone)
                                        <option value="{{ $zone->id }}"
                                                ...
                                                @if(in_array($zone->id, $offer->zones->pluck('id')->toArray())) selected @endif>
                                            {{ $zone->name }}
                                        </option>
                                    @endforeach
                                </select>

...
?>
<a href="{{route('major.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletemajor({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
                            ...
                            <a class="btn btn-success btn-sm" href="{{route('majoroffers.index',$id)}}">الاعلانات</a>
...
<div id="myModals{{$id}}" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
     ...
     <div class="col-6">
         <label>الترتيب</label>
         <input type="number" required  min="0" value="{{$major->order_number}}" name="order_number" id="order_number{{$id}}" class="form-control">
     </div>
...
<div class="row">
    <div class="col-3"></div>
     <div class="col-3">
         <input type="button" onclick="major_order({{$id}})" value="حفظ" class="form-control btn btn-success btn-sm m-4">
     </div>
      </div>

<a href="{{route('majoroffers.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deleteoffer({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">

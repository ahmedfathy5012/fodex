                                ...
                                <span class="svg-icon svg-icon-danger m-0 p-0 svg-icon-md"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-12-28-020759/theme/html/demo8/dist/../src/media/svg/icons/Home/Trash.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            ...
                                            <span class="btn btn-success"data-toggle="modal" data-target="#myModalp{{$id}}" >price</span>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <div class="row">
            ...
            <select class="form-control"  style="display:block;" id="driver_id{{$id}}" data-live-search="true">
        ...
        <div class="row">
            <button class="btn btn-primary mx-auto mt-4" 
           onclick="orderstatus({{$id}},1)" >قبول</button>
            </div>
      </div>
         ...
         <span class="btn btn-danger"  data-toggle="modal" data-target="#myModale{{$id}}">رفض</span>
       ...
       <div class="row">
        ...
        <div class="row">
           ...
           onclick="orderstatus({{$id}},2)" >رفض</button>
                            ...
                            <span class="badge badge-success">مقبوله</span>
                            @else
                             <span class="badge badge-danger">ملغه</span>
                            @endif
                              <a href="{{route('showorders',$id)}}" class="btn btn-success" >show</a>
                            <script>

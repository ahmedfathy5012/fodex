...
<style>
 ...
 <span class="label label-lg font-weight-bold label-light-primary label-inline span" style="cursor:pointer;" data-toggle="modal" data-target="#myModals{{$id}}">التقييم</span>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
            <div class="col-md-6">
	              <p class="text font-weight-bolder mb-2"> تقييم السائق
	              </p>
	         ...
	         <div class="col-md-6">
	              <p class="text font-weight-bolder mb-2"> تقييم المطعم     
	              </p>
...
@if($order->cancel == 1)
 <span class="label label-lg font-weight-bold label-light-danger label-inline span">ملغى</span>
                            ...
                            <span onclick="orderstatus({{$id}},1)" style="cursor:pointer;" class="label label-lg font-weight-bold label-light-success label-inline span">قبول</span>
...
<span class="btn btn-sm btn-success sm-4 span" data-toggle="modal" data-target="#myModalaa{{$id}}">
   قيد التحضير 
</span>

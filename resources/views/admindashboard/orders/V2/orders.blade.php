                ...
                <div class="orders-status-section">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-sm-4 mb-3">
                            <button type="button" onclick="filterstatus('')"
                                    class="btn btn-primary w-100 d-flex justify-content-center align-items-center orders-status-btn">
                                الكل
                            </button>
                        </div>

                        <div class="col-md-2 col-sm-4 mb-3">
                            <button type="button" onclick="filterstatus(0)"
                                    class="btn btn-success w-100 d-flex justify-content-center align-items-center orders-status-btn">
                                جديده
                            </button>
                        </div>
                        ...
                        <div class="col-md-2 col-sm-4 mb-3">
                            <button type="button" onclick="filterstatus(5)"
                                    class="btn btn-danger w-100 d-flex justify-content-center align-items-center orders-status-btn">
                                ملغيه
                            </button>
                        </div>
                    </div>

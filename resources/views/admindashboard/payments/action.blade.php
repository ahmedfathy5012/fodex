<a href="{{route('payments.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletepayments({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">

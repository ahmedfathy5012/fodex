<a href="{{route('state.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletestate({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
                               ...
                               <a href="{{route('state_cities',$id)}}">
                                <img src="{{asset('city.png')}}" class="order_icon" title="المدن">
                            </a>
                            <script>

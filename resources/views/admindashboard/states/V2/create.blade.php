...
@section('content')
    <style>
        ...
        .state-create-card .card-header {
            background: #ffffff;
            border-bottom: 1px solid #edf0f5;
            padding: 22px 26px;
        }

        .state-create-card .card-title {
            margin: 0;
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        .state-create-card .card-icon svg path,
        .state-create-card .card-icon svg polygon {
        ...
        .state-create-page .form-group label {
            font-weight: 700;
            color: #3f4254;
            margin-bottom: 8px;
            font-size: 14px;
        ...
        .state-create-page .form-control,
        .state-create-page .bootstrap-select > .dropdown-toggle {
            min-height: 44px;
        ...
        .state-create-page .form-control:focus,
        .state-create-page .bootstrap-select.show > .dropdown-toggle {
            border-color: #3699ff !important;
            box-shadow: 0 0 0 3px rgba(54, 153, 255, 0.12) !important;
        }

        .state-create-page .bootstrap-select .filter-option {
            text-align: right !important;
        }

        .state-create-page .dropdown-menu {
            border-radius: 12px;
            border: 1px solid #edf0f5;
            box-shadow: 0 10px 26px rgba(0, 0, 0, 0.12);
        }

        .state-create-page .text-danger,
        .state-create-page p[style*="color:red"] {
    ...
    <div class="state-create-page">
        <div class="card card-custom state-create-card">
            <div class="card-header">
                ...
                <span class="card-icon">
                    ...
                    <h3 class="card-label">إضافة محافظة</h3>
                </div>
            </div>
            ...
            <form method="post" action="{{ route('state.store') }}">
                ...
                <div class="card-body state-create-body">
                    ...
                    <div class="state-section">
                        ...
                        <div class="state-map-note">
                            ارسم حدود المحافظة باستخدام أداة Polygon، ويمكنك تحديد الشكل وحذفه ثم رسمه مرة أخرى.
                        </div>

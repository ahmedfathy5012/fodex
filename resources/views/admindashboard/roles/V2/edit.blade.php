...
@section('content')
    <style>
        ...
        /*.role-edit-card .card-icon svg path,*/
        /*.role-edit-card .card-icon svg polygon {*/
        ...
        .role-edit-page .form-group label {
            font-weight: 700;
            color: #3f4254;
            margin-bottom: 8px;
            font-size: 14px;
        ...
        .role-edit-page .text-danger,
        .role-edit-page p[style*="color:red"] {
    ...
    <div class="role-edit-page">
        <div class="card card-custom role-edit-card">
            <div class="card-header">
                ...
                <span class="card-icon">
                    ...
                    <h3 class="card-label">تعديل دور</h3>
                </div>
            </div>
                                        ...
                                        <div class="role-permission-list">
                                            @foreach($maps as $key => $map)
                                                <div class="role-permission-item">
                                                    <input type="checkbox"
                                                           name="permissions[]"
                                                           @if($role->hasPermission($model . '-' . $map)) checked @endif

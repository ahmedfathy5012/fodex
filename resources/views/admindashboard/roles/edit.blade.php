  ...
  <div class="card-body">
   ...
   <div class="form-group col-6">
       ...
       @enderror
             ...
             <div class="col-3">
     <label >     <input type="checkbox" class="form-control" onchange="selectall(this)">الكل </label>
       </div>
          @php
           $models = [ 'country' ,
            'state' ,
                                    ...
                                    <div role="tabpanel" class="tab-pane fade show {{$index == 0 ? 'active' : ''}}" id="{{$model}}">
                                        @foreach($maps as $key => $map)
                                            <div class="checkbox checkbox-success form-check-inline" >
                                                <input type="checkbox" name="permissions[]"@if($role->hasPermission($model .'-'.$map))  checked @endif  style="opacity:1;z-index:2;" id="inlineCheckbox{{$key}}" value="{{$model}}-{{$map}}">

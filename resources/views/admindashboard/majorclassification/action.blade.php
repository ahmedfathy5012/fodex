...
<a href="{{route('majorclassificationselect.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
...
<a href="{{route('majorclassification.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
...
@endif
                            <div style="cursor:pointer;" onclick="deletemajorclassification({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
                                <span class="svg-icon svg-icon-danger m-0 p-0 svg-icon-md"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-12-28-020759/theme/html/demo8/dist/../src/media/svg/icons/Home/Trash.svg-->
                                  ...
                                  <a href="{{route('majoroffers',$id)}}" class="btn btn-success btn-sm" 
     ...
     <div class="col-3">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        ...
                        <a href="{{route('majorcontents',$id)}}" class="btn btn-success btn-sm" 
                                  style="font-size:11px;color:white;">
    content</a> 
                            <script>

...
<div class="card card-custom">
 ...
 <!--begin::Form-->
<form method="post" action="{{route('majorclassificationselect.update',$home->id)}}" enctype="multipart/form-data">
    @csrf
       @method('PUT')
  <div class="card-body">
 ...
 <div class="form-group col-lg-4 col-md-12">
    ...
    required="required" id="title" required="required" data-live-search="true">
        
          <option value="الاكثر مبيعا - 1" style="padding-left:30px;" @if($home->status == 1) selected @endif>الاكثر مبيعا</option>
            <option value="الاقرب اليك - 2" style="padding-left:30px;" @if($home->status == 2) selected @endif> الاقرب اليك</option>
        </select>

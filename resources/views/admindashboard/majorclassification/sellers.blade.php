...
@section('content')
    ...
    <div class="card card-custom gutter-b">
		...
		<div class="card-title">
	      ...
	      <div class="row">
	        <a class="btn btn-sm  mt-4 btning" href="{{route('addsellerclass',$home->id)}}">اضافه</a>
	    </div>
	    <div class="row">
	        <a class="btn btn-sm  mt-4 btning" href="{{route('majorclassificationselect.create',$id)}}">اضافه</a>
	    </div>
        <div class="card-body">
            <!--begin: Datatable-->

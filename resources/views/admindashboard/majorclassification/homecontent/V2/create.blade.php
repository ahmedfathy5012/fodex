...
@section('content')
    <style>
        .major-content-create-page {
            direction: rtl;
        }

        .major-content-create-card {
            border: 0;
            border-radius: 16px;
            overflow: hidden;
            background: #ffffff;
        ...
        .major-content-create-card .card-header {
            background: #ffffff;
            border-bottom: 1px solid #edf0f5;
            padding: 22px 26px;
        }

        .major-content-create-card .card-title {
            margin: 0;
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        .major-content-create-card .card-label {
            margin: 0;
            font-size: 20px;
            font-weight: 800;
            color: #181c32;
        ...
        .major-content-create-card .card-icon {
            width: 42px;
            height: 42px;
            border-radius: 12px;
            background: #eaf4ff;
        ...
        /*.major-content-create-card .card-icon svg path,*/
        /*.major-content-create-card .card-icon svg polygon {*/
        /*    fill: #3699ff !important;*/
        /*}*/

        .major-content-create-body {
            padding: 28px;
            background: #ffffff;
        }
        ...
        .major-content-create-page .form-group label {
            font-weight: 700;
            color: #3f4254;
            margin-bottom: 8px;
            font-size: 14px;
        ...
        .major-content-create-page .form-control,
        .major-content-create-page .bootstrap-select > .dropdown-toggle {
            min-height: 44px;
        ...
        .major-content-create-page .form-control:focus,
        .major-content-create-page .bootstrap-select.show > .dropdown-toggle {
            border-color: #3699ff !important;
            box-shadow: 0 0 0 3px rgba(54, 153, 255, 0.12) !important;
        }

        .major-content-create-page .bootstrap-select .filter-option {
            text-align: right !important;
        }

        .major-content-create-page .dropdown-menu {
            border-radius: 12px;
            border: 1px solid #edf0f5;
            box-shadow: 0 10px 26px rgba(0, 0, 0, 0.12);
        }

        .major-content-create-page .text-danger,
        .major-content-create-page p[style*="color:red"] {
        ...
        .major-content-create-page .image-input {
            position: relative;
            width: 132px;
            height: 132px;
            border-radius: 50%;
        ...
        .major-content-create-page .image-input-wrapper {
        ...
        .major-content-create-page .image-input-wrapper::after {
            content: "صورة";
            position: absolute;
            inset: 0;
            display: flex;
        ...
        .major-content-create-page .image-input-wrapper[style*="url"]::after {
            display: none;
        }

        .major-content-create-page .image-input label.btn {
            position: absolute;
            right: -5px;
            bottom: 8px;
        ...
        .major-content-create-page .image-input label.btn svg path,
        .major-content-create-page .image-input label.btn svg rect,
        .major-content-create-page .image-input label.btn svg circle {
            fill: #3699ff !important;
        }

        .major-content-create-page .image-input input[type="file"] {
            display: none;
        }
    ...
    <div class="major-content-create-page">
        <div class="card card-custom major-content-create-card">
            <div class="card-header">
                ...
                <span class="card-icon">
                    ...
                    <h3 class="card-label">إضافة تصنيف محتوى رئيسي</h3>
                </div>
            </div>

            <form method="post"
                  action="{{ route('storemajorcontent', $id) }}"
                  enctype="multipart/form-data">
                @csrf

                <div class="card-body major-content-create-body">

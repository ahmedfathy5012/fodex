...
<a href="{{route('majorclassificationselect.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletemajorclassificationselect({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
                            ...
                            <script>
              function deletemajorclassificationselect(sel){
    let id = sel;
 console.log(sel);
 ...
 $.ajaxSetup({
  ...
  if (result.isConfirmed) {
    ...
    $.ajax({
       type:"delete",
       url: `../deletemajorclassificationselect/${id}`,

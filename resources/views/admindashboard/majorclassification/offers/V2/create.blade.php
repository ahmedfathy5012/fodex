...
@section('content')
    <style>
        ...
        .major-offer-create-page .image-input {
            position: relative;
            width: 132px;
            height: 132px;
            border-radius: 50%;
        ...
        .major-offer-create-page .image-input-wrapper {
        ...
        .major-offer-create-page .image-input-wrapper::after {
            content: "صورة";
            position: absolute;
            inset: 0;
            display: flex;
        ...
        .major-offer-create-page .image-input-wrapper[style*="url"]::after {
            display: none;
        }

        .major-offer-create-page .image-input label.btn {
            position: absolute;
            right: -5px;
            bottom: 8px;
        ...
        .major-offer-create-page .image-input label.btn svg path,
        .major-offer-create-page .image-input label.btn svg rect,
        .major-offer-create-page .image-input label.btn svg circle {
            fill: #3699ff !important;
        }

        .major-offer-create-page .image-input input[type="file"] {
            display: none;
        }
    ...
    <div class="major-offer-create-page">
        <div class="card card-custom major-offer-create-card">
            ...
            <form method="post"
                  action="{{ route('storemajoroffer', $id) }}"

...
<form method="post" action="{{route('packages.store')}}" enctype="multipart/form-data">
 ...
 @enderror
  ...
  <div class="form-group col-6">
    ...
    <input type="number" class="form-control " value="{{old('showdays')}}" name="showdays"  required="required"/>
    @error('phone')
    <p style="color:red;">{{ $message }}</p>
 @enderror
   </div>   
 ...
 <!--   <input type="number" class="form-control " value="{{old('items_number')}}" name="items_number"  required="required"/>-->
 <!--   @error('phone')-->
 <!--   <p style="color:red;">{{ $message }}</p>-->
 <!--@enderror-->
 <!--  </div> <div class="form-group col-6">-->
 <!--   <label>عدد الاشعارات  <span class="text-danger">*</span></label>-->
 <!--   <input type="number" class="form-control " value="{{old('notifications_number')}}" name="notifications_number"  required="required"/>-->
 <!--   @error('phone')-->
 <!--   <p style="color:red;">{{ $message }}</p>-->
 <!--@enderror-->
 <!--  </div>-->
 ...
 <!--   <input type="number" class="form-control " value="{{old('orders_number')}}" name="orders_number"  required="required"/>-->
 <!--   @error('phone')-->
 <!--   <p style="color:red;">{{ $message }}</p>-->
 <!--@enderror-->
 <!--  </div>-->

...
@section('content')
    <style>
        ...
        /*.package-edit-card .card-icon svg path,*/
        /*.package-edit-card .card-icon svg polygon {*/
        ...
        .package-edit-page .form-group label {
            font-weight: 700;
            color: #3f4254;
            margin-bottom: 8px;
            font-size: 14px;
        ...
        .package-edit-page .form-control,
        .package-edit-page .bootstrap-select > .dropdown-toggle {
            min-height: 44px;
        ...
        .package-edit-page .form-control:focus,
        .package-edit-page .bootstrap-select.show > .dropdown-toggle {
            border-color: #3699ff !important;
            box-shadow: 0 0 0 3px rgba(54, 153, 255, 0.12) !important;
        }

        .package-edit-page .bootstrap-select .filter-option {
            text-align: right !important;
        }

        .package-edit-page .dropdown-menu {
            border-radius: 12px;
            border: 1px solid #edf0f5;
            box-shadow: 0 10px 26px rgba(0, 0, 0, 0.12);
        }

        .package-edit-page .text-danger,
        .package-edit-page p[style*="color:red"] {
    ...
    <div class="package-edit-page">
        <div class="card card-custom package-edit-card">
            <div class="card-header">
                ...
                <span class="card-icon">
                    ...
                    <h3 class="card-label">تعديل باقة</h3>
                </div>
            </div>
            ...
            <form method="post"
                ...
                <div class="card-body package-edit-body">
                                ...
                                <select name="packagecategory_id"
                                    ...
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}"
                                                @if($package->packagecategory_id == $category->id) selected @endif>
                                            {{ $category->title }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="package-section">
                        ...
                        <section id="section">
                            @foreach($package->prices as $price)
                                            ...
                                            <select name="country_id[]"
                                                ...
                                                @foreach($countries as $country)
                                                    <option value="{{ $country->id }}"
                                                            @if($price->country_id == $country->id) selected @endif>
                                                        {{ $country->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                @else
                                    <div class="row package-price-row" id="file{{ $price->id }}">
                                        <div class="form-group col-lg-4 col-md-5">
                                            <label>الدولة <span class="text-danger">*</span></label>
                                            <select name="country_id[]"
                                                    class="form-control selectpicker"

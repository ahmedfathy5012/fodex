...
@section('content')
    <style>
        .employee-contract-edit-page {
            direction: rtl;
        }

        .employee-contract-edit-card {
            border: 0;
            border-radius: 16px;
            overflow: hidden;
            background: #ffffff;
        ...
        .employee-contract-edit-card .card-header {
            background: #ffffff;
            border-bottom: 1px solid #edf0f5;
            padding: 22px 26px;
        }

        .employee-contract-edit-card .card-title {
            margin: 0;
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        .employee-contract-edit-card .card-label {
            margin: 0;
            font-size: 20px;
            font-weight: 800;
            color: #181c32;
        ...
        .employee-contract-edit-card .card-icon {
            width: 42px;
            height: 42px;
            border-radius: 12px;
            background: #eaf4ff;
        ...
        .employee-contract-edit-card .card-icon svg path,
        .employee-contract-edit-card .card-icon svg polygon {
            fill: #3699ff !important;
        }

        .employee-contract-edit-body {
            padding: 28px;
            background: #ffffff;
        }
        ...
        .employee-contract-edit-page .form-group label {
            font-weight: 700;
            color: #3f4254;
            margin-bottom: 8px;
            font-size: 14px;
        ...
        .employee-contract-edit-page .form-control {
            min-height: 44px;
        ...
        .employee-contract-edit-page textarea.form-control {
            min-height: 110px;
            resize: vertical;
        }

        .employee-contract-edit-page .form-control:focus {
            border-color: #3699ff !important;
            box-shadow: 0 0 0 3px rgba(54, 153, 255, 0.12) !important;
        }

        .employee-contract-edit-page .text-danger,
        .employee-contract-edit-page p[style*="color:red"] {
    ...
    <div class="employee-contract-edit-page">
        <div class="card card-custom employee-contract-edit-card">
            ...
            <form method="post" action="{{ route('updateemployeecontract', $contract->id) }}" enctype="multipart/form-data">
                @csrf

                <div class="card-body employee-contract-edit-body">

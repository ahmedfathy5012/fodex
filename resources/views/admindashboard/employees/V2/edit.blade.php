...
@section('content')
    <style>
        ...
        .employee-edit-card .card-header {
            background: #ffffff;
            border-bottom: 1px solid #edf0f5;
            padding: 22px 26px;
        }

        .employee-edit-card .card-title {
            margin: 0;
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        /*.employee-edit-card .card-icon svg path,*/
        /*.employee-edit-card .card-icon svg polygon {*/
        ...
        .employee-edit-page .form-group label {
            font-weight: 700;
            color: #3f4254;
            margin-bottom: 8px;
            font-size: 14px;
        ...
        .employee-edit-page .bootstrap-select > .dropdown-toggle {
            min-height: 44px;
        ...
        .employee-edit-page .form-control:focus,
        .employee-edit-page .bootstrap-select.show > .dropdown-toggle {
            border-color: #3699ff !important;
            box-shadow: 0 0 0 3px rgba(54, 153, 255, 0.12) !important;
        }

        .employee-edit-page .bootstrap-select .filter-option {
            text-align: right !important;
        }

        .employee-edit-page .dropdown-menu {
            border-radius: 12px;
            border: 1px solid #edf0f5;
            box-shadow: 0 10px 26px rgba(0, 0, 0, 0.12);
        }

        .employee-edit-page .text-danger,
        .employee-edit-page p[style*="color:red"] {
    ...
    <div class="employee-edit-page">
        <div class="card card-custom employee-edit-card">
            ...
            <form method="post" action="{{ route('employee.update', $employee->id) }}" enctype="multipart/form-data">
                ...
                <div class="card-body employee-edit-body">
                    ...
                    <div class="employee-section">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-6 col-md-6">
                                ...
                                <select name="country_id"
                                    ...
                                    @foreach($countries as $country)
                                        <option value="{{ $country->id }}" @if($address && $address->country_id == $country->id) selected @endif>
                                            {{ $country->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-lg-6 col-md-6">
                                ...
                                <select name="state_id"
                                    ...
                                    @foreach($states as $state)
                                        <option value="{{ $state->id }}" @if($address && $address->state_id == $state->id) selected @endif>
                                            {{ $state->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-lg-6 col-md-6">
                                ...
                                <select name="city_id"
                                    ...
                                    @foreach($cities as $city)
                                        <option value="{{ $city->id }}" @if($address && $address->city_id == $city->id) selected @endif>
                                            {{ $city->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-lg-6 col-md-6">
                                ...
                                <select name="zone_id"
                                    ...
                                    @foreach($zones as $zone)
                                        <option value="{{ $zone->id }}" @if($address && $address->zone_id == $zone->id) selected @endif>
                                            {{ $zone->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-lg-6 col-md-6">
                                ...
                                <input type="text"
                                       class="form-control"
                                       @if($address) value="{{ $address->street }}" @endif
                                       name="street"/>
                                @error('street')
                                <p style="color:red;">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="form-group col-lg-6 col-md-6">
                                ...
                                <input type="number"
                                       class="form-control"
                                       @if($address) value="{{ $address->building_number }}" @endif
                            ...
                            <div class="form-group col-lg-6 col-md-6">
                                ...
                                <input type="number"
                                       class="form-control"
                                       @if($address) value="{{ $address->floor_number }}" @endif
                                       name="floor_number"/>
                                @error('floor_number')
                                <p style="color:red;">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="form-group col-lg-6 col-md-6">
                                ...
                                <select name="role_id"
                                    ...
                                    @foreach($roles as $role)
                                        <option value="{{ $role->id }}" @if($employee->hasRole($role->name)) selected @endif>
                                            {{ $role->name }}
                                        </option>
                                    @endforeach
                                </select>

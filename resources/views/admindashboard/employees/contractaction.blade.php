...
?>
<a href="{{route('editemployeecontract',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deleteemployeecontract({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
                     ...
                     <span class="btn btn-danger" onclick="activeemployeecontract({{$id}})">الغاء التفعيل</span>
                     @else
                 <span class="btn btn-primary" onclick="activeemployeecontract({{$id}})">تفعيل </span>
                     @endif

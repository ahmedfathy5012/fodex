...
<!--   </div>   </div> -->
 ...
 @enderror
    ...
    <input type="number" class="form-control " value="{{old('building_number')}}" name="building_number" />
    @error('building_number')
    <p style="color:red;">{{ $message }}</p>
 @enderror
   </div>     <div class="form-group col-6">
    <label>رقم الطابق     <span class="text-danger">*</span></label>
    <input type="number" class="form-control " value="{{old('floor_number')}}" name="floor_number"  />
    @error('floor_number')
    <p style="color:red;">{{ $message }}</p>
 @enderror
</div> 
 ...
 <!--  </div> -->
   @php
       ...
       @enderror
                            ...
                            <!--                    <input type="checkbox" name="permissions[]" style="opacity:1;z-index:2;" id="inlineCheckbox{{$key}}" value="{{$model}}-{{$map}}">-->

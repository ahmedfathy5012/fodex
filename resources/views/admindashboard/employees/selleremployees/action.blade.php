...
?>
<a href="{{route('selleremployees.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
...
<input type="hidden" value="{{$id}}" id="id">
                            <div style="curor:pointer;" onclick="deleteemployee({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">

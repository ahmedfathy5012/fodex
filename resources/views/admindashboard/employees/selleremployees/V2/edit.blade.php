...
@section('content')
    <style>
        .selleremployees-form-page {
            direction: rtl;
        }

        .selleremployees-form-card {
            border: 0;
            border-radius: 16px;
            overflow: hidden;
            background: #ffffff;
        ...
        .selleremployees-form-card .card-header {
            background: #ffffff;
            border-bottom: 1px solid #edf0f5;
            padding: 22px 26px;
        }

        .selleremployees-form-card .card-title {
            margin: 0;
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        .selleremployees-form-card .card-label {
            margin: 0;
            font-size: 20px;
            font-weight: 800;
            color: #181c32;
        ...
        .selleremployees-form-card .card-icon {
            width: 42px;
            height: 42px;
            border-radius: 12px;
            background: #eaf4ff;
        ...
        .selleremployees-form-card .card-body {
            padding: 28px;
        }

        .selleremployees-form-card .form-group label,
        .selleremployees-form-card .col-4 label,
        .selleremployees-form-card .col-6 label,
        .selleremployees-form-card .col-lg-4 label,
        .selleremployees-form-card .col-lg-6 label {
            font-weight: 700;
            color: #3f4254;
            margin-bottom: 8px;
            font-size: 14px;
        ...
        .selleremployees-form-card .form-control,
        .selleremployees-form-card .bootstrap-select > .dropdown-toggle {
            min-height: 44px;
        ...
        .selleremployees-form-card .form-control:focus,
        .selleremployees-form-card .bootstrap-select.show > .dropdown-toggle {
            border-color: #3699ff !important;
            box-shadow: 0 0 0 3px rgba(54, 153, 255, 0.12) !important;
        }

        .selleremployees-form-card .row > hr {
            border-top: 1px solid #edf0f5;
            width: 100% !important;
            margin: 24px 0;
        }

        .selleremployees-form-card button[type="submit"] {
            min-width: 150px;
            height: 44px;
            border-radius: 10px !important;
    ...
    <div class="selleremployees-form-page">
        <div class="card card-custom gutter-b selleremployees-form-card">
 ...
 <!--begin::Form-->
<form method="post" action="{{route('selleremployees.update',$employee->id)}}" enctype="multipart/form-data">
    @csrf
    @method('put')
  <div class="card-body">

...
<!--        <div class="image-input-wrapper mb-5" id="im" style="background-image:url({{asset('uploads/'. $driver->image)}})"></div>-->
...
<!--     </div>-->
     <!---->
<!--      <div class="col-6"><div class="image-input image-input-outline image-input-circle" id="kt_image_3">-->
<!--        <div class="image-input-wrapper mb-5" id="im1" style="background-image:url({{asset('uploads/'. $driver->identification_number_image)}})"></div>-->
...
<!--        <div class="image-input-wrapper mb-5" id="im2" style="background-image:url({{asset('uploads/'. $driver->residence_deed_image)}})"></div>-->
...
<!--        <div class="col-6"><div class="image-input image-input-outline image-input-circle" id="kt_image_3">-->
<!--        <div class="image-input-wrapper mb-5" id="im5" style="background-image:url({{asset('uploads/'. $driver->license_image)}})"></div>-->
...
<!--        </span>-->
<!--       </div>-->
<!--     </div> <div class="col-6"><div class="image-input image-input-outline image-input-circle" id="kt_image_3">-->
<!--        <div class="image-input-wrapper mb-5" id="im6" style="background-image:url({{asset('uploads/'. $driver->vehicle_license_image)}})"></div>-->
...
<div class="row"><div class="col-4"><label>المعلومات الرئسيه</label>
   ...
   <div class="form-group col-6">
    ...
    <input type="text" class="form-control " value="{{$driver->name}}" name="name"  required="required"/>
    @error('name')
    <p style="color:red;">{{ $message }}</p>
 @enderror
   </div>   
  <div class="form-group col-6">
    ...
    <input type="text" class="form-control " value="{{$driver->phone}}" name="phone"  required="required"/>
    @error('phone')
    <p style="color:red;">{{ $message }}</p>
 @enderror
   </div>     <div class="form-group col-6">
    <label>رقم الهاتف الثانى (اختياري)    <span class="text-danger">*</span></label>
    <input type="text" class="form-control " value="{{$driver->mobile}}"name="mobile"  />
    @error('mobile')
    <p style="color:red;">{{ $message }}</p>
 @enderror
   </div>    
   ...
   <div class="row">
    ...
    <input type="number" class="form-control " value="{{$driver->commission}}" name="commission"  required="required"/>
    @error('commission')
    <p style="color:red;">{{ $message }}</p>
 @enderror
   </div>        <div class="form-group col-3">
    <label> السعر الثابت<span class="text-danger">*</span></label>
    <input type="number" class="form-control " value="{{$driver->least_price}}" name="least_price"  required="required"/>
    @error('least_price')
    <p style="color:red;">{{ $message }}</p>
 @enderror
   </div>
     ...
     <div class="form-group col-6">
       ...
       @enderror
        ...
        <select name="zone_id" class="form-control selectpicker" id="zone" required="required" data-live-search="true">
          ...
          <option value="{{$zone->id}}" @if($address->zone_id == $zone->id) selected @endif>{{$zone->name}}</option>
          @endforeach
        </select>
       @error('zone_id')
       <p style="color:red;">{{$message}}</p>
 ...
 <div class="form-group col-6">
    ...
    <input type="text" class="form-control " value="{{$address->street}}" name="street"  required="required"/>
    @error('street')
    <p style="color:red;">{{ $message }}</p>
 @enderror
   </div>     <div class="form-group col-6">
    <label>رقم المبنى      <span class="text-danger">*</span></label>
    <input type="number" class="form-control " value="{{$address->building_number}}" name="building_number"  required="required"/>
    @error('building_number')
    <p style="color:red;">{{ $message }}</p>
 @enderror
   </div>     <div class="form-group col-6">
    <label>رقم الطابق     <span class="text-danger">*</span></label>
    <input type="number" class="form-control " value="{{$address->floor_number}}" name="floor_number"  required="required"/>
    @error('floor_number')
    <p style="color:red;">{{ $message }}</p>
 @enderror
       ...
       <div class="form-group col-6">
        ...
        <input type="text" class="form-control " value="{{$address->lat}}" id="Lat" name="lat" />
       </div>
  <div class="form-group col-6">
        <label>lon <span class="text-danger">*</span></label>
        <input type="text" class="form-control " value="{{$address->lon}}"  id="Lng" name="lon" />
       </div>   

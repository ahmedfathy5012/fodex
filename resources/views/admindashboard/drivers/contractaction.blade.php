...
?>
<a href="{{route('editdrivercontract',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletedrivercontract({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
                     ...
                     <span class="btn btn-danger" onclick="activedrivercontract({{$id}})">الغاء التفعيل</span>
                     @else
                 <span class="btn btn-primary" onclick="activedrivercontract({{$id}})">تفعيل </span>
                     @endif

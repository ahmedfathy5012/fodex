...
<div class="row">
 ...
 <!--   <input type="text" class="form-control " value="{{old('qualification')}}" name="qualification"  required="required"/>-->
 <!--   @error('qualification')-->
 <!--   <p style="color:red;">{{ $message }}</p>-->
 <!--@enderror-->
 <!--  </div>     <div class="form-group col-6">-->
 <!--   <label>تاريخ الميلاد    <span class="text-danger">*</span></label>-->
 <!--   <input type="date" class="form-control " value="{{old('birthday')}}" name="birthday"  required="required"/>-->
 <!--   @error('birthday')-->
 <!--   <p style="color:red;">{{ $message }}</p>-->
 <!--@enderror-->
 <!--  </div>          <div class="form-group col-6">-->
 ...
 <!--      @enderror-->
 <!--      </div>     <div class="form-group col-6">-->
 <!--       <label>نوع المركبه <span class="text-danger">*</span></label>-->
 <!--       <select name="vehicletype_id" class="form-control selectpicker" id="gender" required="required" data-live-search="true">-->
 <!--         @foreach($vtypes as $vtype)-->
 <!--         <option value="{{$vtype->id}}">{{$vtype->title}}</option>-->
 <!--         @endforeach-->
 <!--       </select>-->
 <!--      @error('gender_id')-->
 <!--      <p style="color:red;">{{$message}}</p>-->
 ...
 <!--      </div>   -->
 <!--       <div class="form-group col-6">-->
 <!--   <label>رقم رخصه السائق      <span class="text-danger">*</span></label>-->
 <!--   <input type="number" class="form-control " value="{{old('license_number')}}" name="license_number"  required="required"/>-->
 <!--   @error('license_number')-->
 <!--   <p style="color:red;">{{ $message }}</p>-->
 <!--@enderror-->
 <!--  </div>    <div class="form-group col-6">-->
 <!--   <label>رقم رخصه المركبه<span class="text-danger">*</span></label>-->
 <!--   <input type="number" class="form-control " value="{{old('vehicle_license_number')}}" name="vehicle_license_number"  />-->
 <!--   @error('vehicle_license_number')-->
 <!--   <p style="color:red;">{{ $message }}</p>-->
 <!--@enderror-->
 <!--  </div>       <div class="form-group col-6">-->
 <!--   <label>تاريخ الانتهاء من الجيش    <span class="text-danger">*</span></label>-->
 <!--   <input type="date" class="form-control " value="{{old('expiry_date_postponement')}}" name="expiry_date_postponement"  />-->

...
@section('content')
    <style>
        ...
        .driver-edit-card .card-header {
            background: #ffffff;
            border-bottom: 1px solid #edf0f5;
            padding: 22px 26px;
        }

        .driver-edit-card .card-title {
            margin: 0;
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        .driver-edit-card .card-icon svg path,
        .driver-edit-card .card-icon svg polygon {
        ...
        .driver-edit-page .form-group label {
            font-weight: 700;
            color: #3f4254;
            margin-bottom: 8px;
            font-size: 14px;
        ...
        .driver-edit-page .form-control,
        .driver-edit-page .bootstrap-select > .dropdown-toggle {
            min-height: 44px;
        ...
        .driver-edit-page .form-control:focus,
        .driver-edit-page .bootstrap-select.show > .dropdown-toggle {
            border-color: #3699ff !important;
            box-shadow: 0 0 0 3px rgba(54, 153, 255, 0.12) !important;
        }

        .driver-edit-page .bootstrap-select .filter-option {
            text-align: right !important;
        }

        .driver-edit-page .dropdown-menu {
            border-radius: 12px;
            border: 1px solid #edf0f5;
            box-shadow: 0 10px 26px rgba(0, 0, 0, 0.12);
        }

        .driver-edit-page .text-danger,
        .driver-edit-page p[style*="color:red"] {
    ...
    <div class="driver-edit-page">
        <div class="card card-custom driver-edit-card">
            ...
            <form method="post" action="{{ route('driver.update', $driver->id) }}" enctype="multipart/form-data">
                ...
                <div class="card-body driver-edit-body">

...
@section('content')
    <style>
        ...
        .driver-create-card .card-header {
            background: #ffffff;
            border-bottom: 1px solid #edf0f5;
            padding: 22px 26px;
        }

        .driver-create-card .card-title {
            margin: 0;
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        .driver-create-card .card-icon svg path,
        .driver-create-card .card-icon svg polygon {
        ...
        .driver-create-page .form-group label {
            font-weight: 700;
            color: #3f4254;
            margin-bottom: 8px;
            font-size: 14px;
        ...
        .driver-create-page .form-control,
        .driver-create-page .bootstrap-select > .dropdown-toggle {
            min-height: 44px;
        ...
        .driver-create-page .form-control:focus,
        .driver-create-page .bootstrap-select.show > .dropdown-toggle {
            border-color: #3699ff !important;
            box-shadow: 0 0 0 3px rgba(54, 153, 255, 0.12) !important;
        }

        .driver-create-page .bootstrap-select .filter-option {
            text-align: right !important;
        }

        .driver-create-page .dropdown-menu {
            border-radius: 12px;
            border: 1px solid #edf0f5;
            box-shadow: 0 10px 26px rgba(0, 0, 0, 0.12);
        }

        .driver-create-page .text-danger,
        .driver-create-page p[style*="color:red"] {
    ...
    <div class="driver-create-page">
        <div class="card card-custom driver-create-card">
            <div class="card-header">
                ...
                <span class="card-icon">
                    ...
                    <h3 class="card-label">إضافة سائق</h3>
                </div>
            </div>
            ...
            <form method="post" action="{{ route('driver.store') }}" enctype="multipart/form-data">
                ...
                <div class="card-body driver-create-body">
                    <div class="driver-section">
                        <div class="driver-section-title">المعلومات الرئيسية</div>
                    ...
                    <div class="driver-section">
                        <div class="driver-section-title">المعلومات الشخصية</div>
                    ...
                    <div class="driver-section">
                        <div class="driver-section-title">معلومات العنوان</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div id="map" class="driver-map"></div>
                            </div>
                ...
                <div class="driver-submit-wrapper">
                    <button type="submit" class="btn btn-shadow btn-primary font-weight-bold driver-submit-btn">
                        إضافة

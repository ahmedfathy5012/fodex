...
<div class="card card-custom">
    ...
    <div class="card-header">
		<div class="card-title">
			...
			<h3 class="card-label">   اضافه صرف </h3>
		</div>
	</div>
  ...
  <div class="card-body">
   <div class ="row">
      <div class="form-group col-6">
        ...
        <select name="expensestype_id" class="form-control selectpicker" onchange="filterexpensetype(this)" required>
        ...
        <input type="number" class="form-control " disabled id="paid" value="{{old('paid')}}" min="0"  required />
          <input type="hidden" class="form-control "  id="paid1" value="{{old('paid')}}" min="0" name="paid" required />
       @error('paid')

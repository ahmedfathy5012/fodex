...
@section('content')
    <style>
        .company-driver-create-page {
            direction: rtl;
        }

        .company-driver-create-card {
            border: 0;
            border-radius: 16px;
            overflow: hidden;
            background: #ffffff;
        ...
        .company-driver-create-card .card-header {
            background: #ffffff;
            border-bottom: 1px solid #edf0f5;
            padding: 22px 26px;
        }

        .company-driver-create-card .card-title {
            margin: 0;
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        .company-driver-create-card .card-label {
            margin: 0;
            font-size: 20px;
            font-weight: 800;
            color: #181c32;
        ...
        .company-driver-create-card .card-icon {
            width: 42px;
            height: 42px;
            border-radius: 12px;
            background: #eaf4ff;
        ...
        /*.company-driver-create-card .card-icon svg path,*/
        /*.company-driver-create-card .card-icon svg polygon {*/
        /*    fill: #3699ff !important;*/
        /*}*/

        .company-driver-create-body {
            padding: 28px;
            background: #ffffff;
        }
        ...
        .company-driver-create-page .form-group label {
            font-weight: 700;
            color: #3f4254;
            margin-bottom: 8px;
            font-size: 14px;
        ...
        .company-driver-create-page .form-control,
        .company-driver-create-page .bootstrap-select > .dropdown-toggle {
            min-height: 44px;
        ...
        .company-driver-create-page .form-control:focus,
        .company-driver-create-page .bootstrap-select.show > .dropdown-toggle {
            border-color: #3699ff !important;
            box-shadow: 0 0 0 3px rgba(54, 153, 255, 0.12) !important;
        }

        .company-driver-create-page .bootstrap-select .filter-option {
            text-align: right !important;
        }

        .company-driver-create-page .dropdown-menu {
            border-radius: 12px;
            border: 1px solid #edf0f5;
            box-shadow: 0 10px 26px rgba(0, 0, 0, 0.12);
        }

        .company-driver-create-page .text-danger,
        .company-driver-create-page p[style*="color:red"] {
    ...
    <div class="company-driver-create-page">
        <div class="card card-custom company-driver-create-card">
            ...
            <form method="post" action="{{ route('company_drivers.store', $id) }}" enctype="multipart/form-data">
                ...
                <div class="card-body company-driver-create-body">

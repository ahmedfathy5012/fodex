            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <select name="state_id" class="form-control selectpicker" onchange="getcities(this)" id="state"
                                required="required" data-live-search="true">
                    ...
                    <div class="form-group col-6">
                        ...
                        <select name="city_id" class="form-control selectpicker" id="city" required="required"
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control " required="required" value="{{old('name')}}"
                               name="name"/>
                        @error('name')
                        <p style="color:red;">{{$message}}</p>
                        @enderror

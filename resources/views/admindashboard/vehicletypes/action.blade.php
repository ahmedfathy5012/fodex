<a href="{{route('vehicletypes.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletegender({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">

...
<div class="card card-custom">
 ...
 <!--begin::Form-->
<form method="post" action="{{route('workschedule.store')}}" enctype="multipart/form-data">
    @csrf
  <div class="card-body">
     ...
     <div class="form-group col-lg-4 col-md-6">
        ...
        <select name="seller_id" class="form-control selectpicker" required="required" id="seller_id" required="required" data-live-search="true">

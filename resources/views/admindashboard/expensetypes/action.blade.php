<a href="{{route('expensetype.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deleteexpensetype({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">

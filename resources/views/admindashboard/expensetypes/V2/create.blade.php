...
@section('content')
    <style>
        .expensetype-create-page {
            direction: rtl;
        }

        .expensetype-create-card {
            border: 0;
            border-radius: 16px;
            overflow: hidden;
            background: #ffffff;
        ...
        .expensetype-create-card .card-header {
            background: #ffffff;
            border-bottom: 1px solid #edf0f5;
            padding: 22px 26px;
        }

        .expensetype-create-card .card-title {
            margin: 0;
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        .expensetype-create-card .card-label {
            margin: 0;
            font-size: 20px;
            font-weight: 800;
            color: #181c32;
        ...
        .expensetype-create-card .card-icon {
            width: 42px;
            height: 42px;
            border-radius: 12px;
            background: #eaf4ff;
        ...
        /*.expensetype-create-card .card-icon svg path,*/
        /*.expensetype-create-card .card-icon svg polygon {*/
        /*    fill: #3699ff !important;*/
        /*}*/

        .expensetype-create-body {
            padding: 28px;
            background: #ffffff;
        }
        ...
        .expensetype-create-page .form-group label {
            font-weight: 700;
            color: #3f4254;
            margin-bottom: 8px;
            font-size: 14px;
        ...
        .expensetype-create-page .form-control {
            min-height: 44px;
        ...
        .expensetype-create-page .form-control:focus {
            border-color: #3699ff !important;
            box-shadow: 0 0 0 3px rgba(54, 153, 255, 0.12) !important;
        }

        .expensetype-create-page .text-danger,
        .expensetype-create-page p[style*="color:red"] {
    ...
    <div class="expensetype-create-page">
        <div class="card card-custom expensetype-create-card">
            ...
            <form method="post" action="{{ route('expensetype.store') }}">
                ...
                <div class="card-body expensetype-create-body">

<a href="{{route('packagescategories.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletepackagescategories({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">

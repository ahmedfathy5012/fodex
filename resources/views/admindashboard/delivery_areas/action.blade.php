<a href="{{route('delivery_areas.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletedelivery_areas({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
                            ...
                            <script>
              function deletedelivery_areas(sel){
    let id = sel;
 console.log(sel);

...
<div class="card card-custom">
 ...
 <!--begin::Form-->
<form method="post" action="{{route('delivery_areas.update',$delivery_area->id)}}">
  ...
  <div class="card-body">
   ...
   <div class="form-group col-6">
        ...
        <select name="country_id" class="form-control selectpicker" onchange="getstates(this)" required="required" data-live-search="true">
          ...
          <option value="{{$country->id}}" @if($delivery_area->country_id == $country->id) selected @endif>{{$country->name}}</option>
          @endforeach
        </select>
       @error('name')
       ...
       <div class="form-group col-6">
        ...
        <select name="state_id" class="form-control selectpicker" onchange="getcities(this)" id="state" required="required" data-live-search="true">
          ...
          <option value="{{$state->id}}" @if($delivery_area->state_id == $state->id) selected @endif>{{$state->name}}</option>
          @endforeach
        </select>
       @error('state_id')
       <p style="color:red;">{{$message}}</p>
       @enderror
        ...
        <select name="city_id" class="form-control selectpicker" id="city" required="required" data-live-search="true">
          ...
          <option value="{{$city->id}}" @if($delivery_area->city_id == $city->id) selected @endif>{{$city->name}}</option>
          @endforeach
        </select>
       @error('city_id')
       <p style="color:red;">{{$message}}</p>
   ...
   <div class="form-group col-6">
        ...
        <input type="text" class="form-control " required="required" value="{{$delivery_area->name}}"name="name" />
       @error('name')
       <p style="color:red;">{{$message}}</p>
       @enderror
       </div>
        ...
        <input type="number" class="form-control " required="required" value="{{$delivery_area->price}}" name="price" />
       @error('price')
       <p style="color:red;">{{$message}}</p>
       @enderror
       </div>

...
class Item extends Model 
{
    ...
    protected $fillable = array('id','title', 'description', 'price', 'discount','discount_from','discount_to',
    'category_id','subcategory_id','major_id','seller_id', 'availability', 'not_available_reason', 'appear', 'not_appear_reason', 'prepare_time', 'calory','fav');
    protected $visible = array('id','title', 'description', 'price',
    'discount_from','discount_to','category_id','subcategory_id','major_id', 'discount', 'seller_id', 'availability', 'not_available_reason', 'appear', 'not_appear_reason', 'prepare_time', 'calory','fav');
   protected $appends = [
        'count_number',
        'currency'

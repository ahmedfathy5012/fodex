...
class MajorsclassificationOfferDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
              ->eloquent($query)
->addColumn('image',function(MajorsclassificationOffer $offer){
    if($offer->image){
     ...
     */
    public function query(MajorsclassificationOffer $model)
    {

...
class EmployeescontractDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
               ->addColumn('paper_contract_image',function(Employeescontract $Sellercategory){
     ...
     *
     * @param \App\Models\Employeescontract $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Employeescontract $model)
    {
        return $model->where('employee_id',$this->id);
    }
   ...
   public function html()
    ...
    {
        return 'Employeescontract_' . date('YmdHis');
    }
}

...
class SellerContentDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
 ->eloquent($query)
 ->editColumn('major_id',function(HomecontentSeller $seller){
             ...
             //   if($seller->seller){
              ...
              //  }
            })->editColumn('phone',function(HomecontentSeller $seller){
             //   if($seller->seller){
     ...
     */
    public function query(HomecontentSeller $model)
    {
  //    $sellers_ids = HomeContent::where('id',$this->id)->first()->sellers;//->orderBy('homecontent_sellers.status','desc');//->pluck('seller_id')->toArray();
   ...
   //      $sellers = HomecontentSeller::where('homecontent_id',$this->id)->orderBy('status','desc')->get();
         $sellers = $model->newQuery()->where('homecontent_id',$this->id)->orderBy('status','desc');
         return $sellers;
    }

...
class MajorClassificationDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
->addColumn('image',function(MajorClassification $home){
    if($home->image){
            ...
            return '<a  href="' . route("sellersclass",$home->id) . '" />'.$home->title.'</a>';
              ...
              }) ->editColumn('major_id',function(MajorClassification $home){
     ...
     */
    public function query(majorclassification $model)
    {
    ...
    protected function getColumns()
    {
     ...
     // ['data'=>'id','title'=>'id','visible' => false, 'printable' => false, 'exportable' => true],
         ['data'=>'image','title'=>'الصوره'],
            ...
            ['data'=>'major_id','title'=>'القسم الرئيسى ' ,'printable'=>false,'exportable'=>false,'orderable'=>false,'searchable'=>false],

...
class CityOrderDataTable extends DataTable
{
    ...
    public function dataTable($query,Request $request)
    {
             return datatables()
            ->eloquent($query)
             ->editColumn('order_number',function(City $City){
          
                    $orders = $City->done_orders()
                ...
                return count($orders);
            })->editColumn('total',function(City $City){
           $orders = $City->done_orders()
                    ->where(function ($query)  {
            ...
            })->editColumn('seller_commission',function(City $City){

...
class CompanyOrderDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query,Request $request)
    {
        return datatables()
           ...
           ->addColumn('action', 'admindashboard.driver_companies.orders.V2.action')
            ->rawColumns([
           'action',
  ...
  //   $country_id = $this->request()->get('country_id');
   ...
   //  $to = $this->request()->get('to');
        ...
        // }]);
        // }]);
         $orders = $model->newQuery()->where('company_id',$this->id);

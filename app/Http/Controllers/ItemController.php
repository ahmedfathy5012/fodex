...
class ItemController extends Controller
{
    ...
    private function itemView(string $page): string
    {
        return env('APP_ENV') == 'production'
            ? "admindashboard.items.$page"
            : "admindashboard.items.V2.$page";
    }
    ...
    public function create()
    {
        ...
        return view($this->itemView('create'))
    ...
    public function edit($id)
    {
        ...
        return view($this->itemView('edit'))
            ->with('sellers', $sellers)
            ->with('item', $item)
            ->with('categories', $categories);
    }

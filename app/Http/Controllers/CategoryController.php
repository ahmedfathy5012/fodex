...
class CategoryController extends Controller
{
    ...
    private function categoryView(string $page): string
    {
        return env('APP_ENV') == 'production'
            ? "admindashboard.categories.$page"
            : "admindashboard.categories.V2.$page";
    }

    public function index(CategoryDataTable $dataTable)
    {
        return $dataTable->render($this->categoryView('index'));
    }
    ...
    public function edit($id)
    {
        ...
        return view($this->categoryView('edit'))
            ->with('majors', $majors)
    ...
    public function sellercategory(SellercategoryDataTable $dataTable, $id)
    {
        ...
        return $dataTable->render($this->categoryView('seller_categories'));
    }
    ...
    {
        $seller_category = Sellercategory::where([

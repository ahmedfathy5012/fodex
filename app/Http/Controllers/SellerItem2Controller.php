 ...
 use generaltrait;
   ...
   public function index(SellerItemDataTable $dataTable,$id)
    ...
    $seller = Seller::where('id',$id)->first();
     $dataTable->id = $id;
       return $dataTable->render('admindashboard.seller_items.index',["seller" => $seller]);
    }
  ...
  public function create($id)
  {
    ...
    return view('admindashboard.seller_items.create')->with('categories',$categories)->with("seller",$seller);
  }

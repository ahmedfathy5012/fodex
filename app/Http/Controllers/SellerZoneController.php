...
{
    private function sellerZoneView(string $page): string
    {
        return env('APP_ENV') == 'production'
            ? "admindashboard.sellers.zones.$page"
            : "admindashboard.sellers.zones.V2.$page";
    }
    ...
    public function index(SellerZoneDataTable $dataTable, $id)
    {
        // dd(Country::all());
        $dataTable->id = $id;
        return $dataTable->render($this->sellerZoneView('index'), [
            'id' => $id
        ]);
    }
    ...
    public function create($id)
    {
        ...
        return view($this->sellerZoneView('create'), compact("zones", "id"));
    }
    ...
    public function edit($id)
    {
        ...
        return view($this->sellerZoneView('edit'), compact("sellerzone", "zones"));
    }
    ...
    public function update($id, Request $request)
    {
        ...
        $request->validate([
            'zone_id' => Rule::unique('seller_zones')
                ->ignore($id, 'id')
        ...
        return redirect()->route('sellerzones', [
            'id' => $sellerzone->seller_id
        ]);
    }

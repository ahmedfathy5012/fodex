...
class StatisticController extends Controller
{
    ...
    private function staticView(string $page): string
    {
        return env('APP_ENV') == 'production'
        ? "admindashboard.statistic.$page"
        : "admindashboard.statistic.V2.$page";
    }
    ...
    public function statistic()
    {
        ...
        $cities = City::all();
        $zones = Zone::all();
        return view($this->staticView("statistic"), ['countries' => $countries, 'states' => $states, 'cities' => $cities, 'zones' => $zones]);
    }
...
// ->with("orderitems") > 0){
    ...
    public function countrystatistic()
    {
        ...
        return view($this->staticView("countrystatistic"));
    }
    ...
    public function employeestatistic()
    {
        ...
        $cities = City::all();
        $zones = Zone::all();
        return view($this->staticView("employeestatistic"), ['countries' => $countries, 'states' => $states, 'cities' => $cities, 'zones' => $zones]);
    }
}

...
{
    private function zoneView(string $page): string
    {
        return env('APP_ENV') == 'production'
            ? "admindashboard.zones.$page"
            : "admindashboard.zones.V2.$page";
    }

    public function index(ZoneDataTable $dataTable)
    {
        return $dataTable->render($this->zoneView('index'));
    }
    ...
    public function create()
    {
        ...
        return view($this->zoneView('create'), compact("countries", "states", "cities"));
    }
    ...
    public function edit($id)
    {
        ...
        return view($this->zoneView('edit'), compact("countries", "states", "cities", "zone"));
    }

...
class HomeContentController extends Controller
{
    ...
    private function homeContentView(string $page): string
    {
        return env('APP_ENV') == 'production'
            ? "admindashboard.homecontent.$page"
            : "admindashboard.homecontent.V2.$page";
    }

    public function index(HomeContentDataTable $dataTable)
    {
        return $dataTable->render($this->homeContentView('index'));
    }
    ...
    public function create()
    {
        ...
        return view($this->homeContentView('create'), compact("sellers", "zones"));
    }
    ...
    public function edit($id)
    {
        ...
        return view($this->homeContentView('edit'), compact("sellers", "zones", "home"));
    }
    ...
    public function sellerscontent(SellerContentDataTable $dataTable, $id)
    {
        ...
        return $dataTable->render($this->homeContentView('sellers'), [
            'home' => $home,
        ]);
    }
    ...
    public function addseller($id)
    {
        ...
        return view($this->homeContentView('addseller'))

...
class SellerEmployeeController extends Controller
{
    ...
    private function sellerEmployeeView(string $page): string
    {
        return env('APP_ENV') == 'production'
            ? "admindashboard.employees.selleremployees.$page"
            : "admindashboard.employees.selleremployees.V2.$page";
    }
    ...
    public function index(SellerEmployeeDataTable $dataTable, $id)
    {
        ...
        return $dataTable->render($this->sellerEmployeeView('index'), [
            'id' => $id
        ]);
    }
    ...
    {
        return view($this->sellerEmployeeView('create'))
            ->with('id', $id);
    }
    ...
    public function store(Request $request, $id)
    {
        ...
        $request->validate([
            'phone' => 'required|unique:sellers_employees'
        ]);
    ...
    public function show(EmployeescontractDataTable $dataTable, $id)
    {
        ...
        return $dataTable->render('admindashboard.employees.V2.show', [
            'employee' => $employee,
            'contract' => $contract
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view($this->sellerEmployeeView('edit'))
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            'phone' => "required|unique:sellers_employees,phone,$id"
        ]);
    ...
    public function employeecontracts(EmployeescontractDataTable $dataTable, $id)
    {
        ...
        return $dataTable->render('admindashboard.employees.V2.contracts', [
            'id' => $id
        ]);
    }
    ...
    {
        return view('admindashboard.employees.V2.addemployeecontract')
            ->with('id', $id);
    }

    public function storeemployeecontract(Request $request, $id)
    {
        Employeescontract::where('employee_id', $id)
            ->update(['active' => 0]);
    ...
    public function editemployeecontract($id)
    {
        ...
        return view('admindashboard.employees.V2.editemployeecontract')

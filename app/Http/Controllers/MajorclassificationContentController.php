...
class MajorclassificationContentController extends Controller
{
    ...
    private function majorclassificationContentView(string $page): string
    {
        return env('APP_ENV') == 'production'
            ? "admindashboard.majorclassification.homecontent.$page"
            : "admindashboard.majorclassification.homecontent.V2.$page";
    }
    ...
    public function index(MajorclassificationContentDataTable $dataTable, $id)
    {
        ...
        return $dataTable->render($this->majorclassificationContentView('index'), [
            'id' => $id,
        ]);
    }
    ...
    public function create($id)
    {
        ...
        return view($this->majorclassificationContentView('create'))
    ...
    public function edit($id)
    {
        ...
        return view($this->majorclassificationContentView('edit'))
            ->with('sellers', $sellers)
            ->with('home', $home);
    }
    ...
    public function sellersmajorcontent(MajorclassificationcontentSellerDataTable $dataTable, $id)
    {
        ...
        return $dataTable->render($this->majorclassificationContentView('sellers'), [
            'home' => $home,
        ]);
    }
    ...
    public function addsellermajorcontent($id)
    {
        ...
        return view($this->majorclassificationContentView('addseller'))
            ->with('sellers', $sellers)
            ->with('home', $home);
    }

...
class SellerItemController extends Controller 
{
 ...
 use generaltrait;
   ...
   public function index(Item2DataTable $dataTable)
    {

       return $dataTable->render('sellerdashboard.items.index');
    }
  ...
  public function create()
  {
    ...
    return view('sellerdashboard.items.create',compact('categories','seller'));
  }
 ...
 if($request->sizename){
    ...
    return redirect()->route('myitems.index');
  }
  ...
  public function edit($id)
  {
    ...
    return view('sellerdashboard.items.edit')->with('item',$item)->with('categories',$categories);
  }
